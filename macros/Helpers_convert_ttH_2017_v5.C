...
void convert_tree(TString sample, int iso_tau=0,
  ...
  if(sample=="test"){
   ...
   // dir_out="/data_CMS/cms/strebler/ttH_prod_80X_01_2017/ntuples_converted/";
    dir_out="/data_CMS/cms/mperez/ttH_test/ntuples_converted/";
  ...
  if(sample=="ttHJet_Hnonbb_Moriond17"){
    ...
    dir_in="/data_CMS/cms/mperez/ttH_test_2016/ntuples_LLRHiggsTauTau/";
    dir_out="/data_CMS/cms/mperez/ttH_test_2016/ntuples_converted/";
    ...
    dir_out+="ttH/";
    list.push_back(dir_in+"synchNtuple_HTauTauAnalysis.root");
  }
  */

  else if(sample=="sync_ttH_94X"){
    file="syncNtuple_94X_v16_jetBTagDeepCSV_100events";
...
/*
  ...
  */
  ...
  vector<float> *_daughters_miniRelIsoChg_2;
  vector<float> *_daughters_miniRelIsoAll_2;
  vector<float> *_daughters_PFRelIsoChg_2;
  vector<float> *_daughters_PFRelIsoAll_2;
  vector<float> *_daughters_PFRelIsoAll04_2;
  vector<float> *_daughters_jetPtRatio_2;
  vector<float> *_daughters_jetPtRel_2;
  vector<float> *_daughters_jetNDauChargedMVASel_2;
  ...
  tree->SetBranchAddress("daughters_miniRelIsoChg_2",&_daughters_miniRelIsoChg_2);
  tree->SetBranchAddress("daughters_miniRelIsoAll_2",&_daughters_miniRelIsoAll_2);
  tree->SetBranchAddress("daughters_PFRelIsoChg_2",&_daughters_PFRelIsoChg_2);
  tree->SetBranchAddress("daughters_PFRelIsoAll_2",&_daughters_PFRelIsoAll_2);
  tree->SetBranchAddress("daughters_PFRelIsoAll04_2",&_daughters_PFRelIsoAll04_2);

  tree->SetBranchAddress("daughters_jetPtRatio_2",&_daughters_jetPtRatio_2);
  tree->SetBranchAddress("daughters_jetPtRel_2",&_daughters_jetPtRel_2);
  tree->SetBranchAddress("daughters_jetNDauChargedMVASel_2",&_daughters_jetNDauChargedMVASel_2);
  ...
  vector<int>   _recoele_jetNDauChargedMVASel_2;
  vector<float> _recoele_miniRelIso;
  vector<float> _recoele_miniRelIsoAll_2;
  vector<float> _recoele_PFRelIsoAll_2;
  vector<float> _recoele_PFRelIsoAll04_2;
  vector<float> _recoele_miniIsoCharged;
  vector<float> _recoele_miniIsoChg_2;
  vector<float> _recoele_PFIsoChg_2;
  vector<float> _recoele_miniIsoNeutral;
  vector<float> _recoele_miniIsoNeutr_2;
  vector<float> _recoele_PFIsoNeutr_2;
  vector<float> _recoele_sip3D;
  vector<float> _recoele_jetPtRel;
  vector<float> _recoele_jetPtRel_2;
  vector<float> _recoele_jetCSV;
  vector<float> _recoele_jetDeepCSV;
  vector<float> _recoele_jetPtRatio;
  vector<float> _recoele_jetPtRatio_2;
  ...
  tree_new->Branch("recomu_jetNDauChargedMVASel_2",&_recomu_jetNDauChargedMVASel_2); //taken from nanoAOD plugin
  tree_new->Branch("recomu_miniRelIso",&_recomu_miniRelIso);
  tree_new->Branch("recomu_miniRelIsoAll_2",&_recomu_miniRelIsoAll_2);
  tree_new->Branch("recomu_miniIsoCharged",&_recomu_miniIsoCharged);
  tree_new->Branch("recomu_miniIsoChg_2",&_recomu_miniIsoChg_2); 
  tree_new->Branch("recomu_miniIsoNeutral",&_recomu_miniIsoNeutral);
  tree_new->Branch("recomu_miniIsoNeutr_2",&_recomu_miniIsoNeutr_2);  
  tree_new->Branch("recomu_sip3D",&_recomu_sip3D);
  tree_new->Branch("recomu_jetPtRel",&_recomu_jetPtRel);
  tree_new->Branch("recomu_jetPtRel_2",&_recomu_jetPtRel_2);
  ...
  tree_new->Branch("recomu_jetPtRatio_2",&_recomu_jetPtRatio_2);
  ...
  tree_new->Branch("recoele_jetNDauChargedMVASel_2",&_recoele_jetNDauChargedMVASel_2);
  tree_new->Branch("recoele_miniRelIso",&_recoele_miniRelIso);
  tree_new->Branch("recoele_miniRelIsoAll_2",&_recoele_miniRelIsoAll_2);
  tree_new->Branch("recoele_PFRelIsoAll_2",&_recoele_PFRelIsoAll_2);
  tree_new->Branch("recoele_PFRelIsoAll04_2",&_recoele_PFRelIsoAll04_2);
  tree_new->Branch("recoele_miniIsoCharged",&_recoele_miniIsoCharged);
  tree_new->Branch("recoele_miniIsoChg_2",&_recoele_miniIsoChg_2);
  tree_new->Branch("recoele_PFIsoChg_2",&_recoele_PFIsoChg_2);
  tree_new->Branch("recoele_miniIsoNeutral",&_recoele_miniIsoNeutral);
  tree_new->Branch("recoele_miniIsoNeutr_2",&_recoele_miniIsoNeutr_2);
  tree_new->Branch("recoele_PFIsoNeutr_2",&_recoele_PFIsoNeutr_2);
  tree_new->Branch("recoele_sip3D",&_recoele_sip3D);
  tree_new->Branch("recoele_jetPtRel",&_recoele_jetPtRel);
  tree_new->Branch("recoele_jetPtRel_2",&_recoele_jetPtRel_2);
  ...
  tree_new->Branch("recoele_jetPtRatio_2",&_recoele_jetPtRatio_2);
  ...
  for (int i=skip_entries;i<skip_entries+nentries;i++) {
    ...
    _recoele_jetNDauChargedMVASel_2.clear();
    _recoele_miniRelIso.clear();
    _recoele_miniRelIsoAll_2.clear();
    _recoele_PFRelIsoAll_2.clear();
    _recoele_PFRelIsoAll04_2.clear();
    _recoele_miniIsoCharged.clear();
    _recoele_miniIsoChg_2.clear();
    _recoele_PFIsoChg_2.clear();
    _recoele_PFIsoChg_2.clear();
    _recoele_miniIsoNeutral.clear();
    _recoele_miniIsoNeutr_2.clear();
    _recoele_PFIsoNeutr_2.clear();
    _recoele_sip3D.clear();
    _recoele_jetPtRel.clear();
    _recoele_jetPtRel_2.clear();
    _recoele_jetCSV.clear();
    _recoele_jetDeepCSV.clear();
    _recoele_jetPtRatio.clear();
    _recoele_jetPtRatio_2.clear();
    ...
    _daughters_jetNDauChargedMVASel_2 = 0;
    _daughters_miniRelIsoCharged = 0;
    _daughters_miniRelIsoNeutral = 0;
    _daughters_miniRelIsoChg_2 = 0;
    _daughters_miniRelIsoAll_2 = 0;
    _daughters_PFRelIsoChg_2 = 0;
    _daughters_PFRelIsoAll_2 = 0;
    _daughters_PFRelIsoAll04_2 = 0;
    _daughters_jetPtRel = 0;
    _daughters_jetPtRel_2 = 0;
    _daughters_jetPtRatio = 0;
    _daughters_jetPtRatio_2 = 0;
	...
	float miniRelIsoCharged = (*_daughters_miniRelIsoCharged)[i_daughter];
        ...
        float miniRelIsoChg_2 = (*_daughters_miniRelIsoChg_2)[i_daughter]; //rel
        float miniRelIsoAll_2 = (*_daughters_miniRelIsoAll_2)[i_daughter]; //rel
	float miniRelIsoNeutr_2 = miniRelIsoAll_2 - miniRelIsoChg_2; // rel
	...
	bool looseID = (*_daughters_muonID)[i_daughter] & 1;
        ...
        if(daughter.Pt()>5 && fabs(daughter.Eta())<2.4 && fabs(dxy)<=0.05 && fabs(dz)<0.1 && miniRelIsoAll_2<0.4 && sip < 8 && looseID){
	  
          lepMVA_pt = daughter.Pt();
	  lepMVA_eta = daughter.Eta();
	  lepMVA_jetNDauChargedMVASel = (*_daughters_jetNDauChargedMVASel_2)[i_daughter]; //from nanoAOD
          lepMVA_miniRelIsoCharged = miniRelIsoChg_2; //from nanoAOD
	  lepMVA_miniRelIsoNeutral = miniRelIsoNeutr_2; //from nanoAOD

	  lepMVA_jetPtRel   = 0.; 
	  lepMVA_jetPtRatio = 1.;      
	  
          if(_daughters_dR_closest_jet[i_daughter]<0.4){   
	    lepMVA_jetPtRel   = (*_daughters_jetPtRel_2)[i_daughter]; //nanoAOD
	    lepMVA_jetPtRatio = std::min((*_daughters_jetPtRatio_2)[i_daughter],float(1.5)); //nanoAOD     
          }
	  else{
    ...
    for(unsigned int i_mu=0; i_mu<reco_mus.size(); i_mu++){
      ...
      _recomu_jetNDauChargedMVASel_2.push_back( (*_daughters_jetNDauChargedMVASel_2)[i_daughter] );     
      _recomu_miniRelIso.push_back( (*_daughters_miniRelIsoCharged)[i_daughter] + (*_daughters_miniRelIsoNeutral)[i_daughter] );
      _recomu_miniRelIsoAll_2.push_back( (*_daughters_miniRelIsoAll_2)[i_daughter] ); 
      _recomu_miniIsoCharged.push_back( muon.Pt()*(*_daughters_miniRelIsoCharged)[i_daughter] );
      _recomu_miniIsoChg_2.push_back( muon.Pt()*(*_daughters_miniRelIsoChg_2)[i_daughter] ); //not the relative one
      _recomu_miniIsoNeutral.push_back( muon.Pt()*(*_daughters_miniRelIsoNeutral)[i_daughter] );
      _recomu_miniIsoNeutr_2.push_back( muon.Pt()*(((*_daughters_miniRelIsoAll_2)[i_daughter]) - (*_daughters_miniRelIsoChg_2)[i_daughter]));
	...
	_recomu_jetPtRel_2.push_back( (*_daughters_jetPtRel_2)[i_daughter] );
        _recomu_jetPtRatio.push_back( std::min((*_daughters_jetPtRatio)[i_daughter],float(1.5)) );
        _recomu_jetPtRatio_2.push_back( std::min((*_daughters_jetPtRatio_2)[i_daughter],float(1.5)) );
      }
      else{
        _recomu_jetPtRel.push_back( 0. );  
	_recomu_jetPtRel_2.push_back( 0. );
        _recomu_jetPtRatio.push_back( 1 / ( 1+(*_combreliso)[i_daughter] ) );
        _recomu_jetPtRatio_2.push_back( 1 / ( 1+(*_combreliso)[i_daughter] ) );
      }
      ...
      lepMVA_jetNDauChargedMVASel = _recomu_jetNDauChargedMVASel_2[i_mu];
      lepMVA_miniRelIsoCharged = _recomu_miniIsoChg_2[i_mu] / lepMVA_pt;
      lepMVA_miniRelIsoNeutral = _recomu_miniIsoNeutr_2[i_mu] / lepMVA_pt;
      lepMVA_jetPtRel   = _recomu_jetPtRel_2[i_mu]; 
      lepMVA_jetPtRatio = _recomu_jetPtRatio_2[i_mu]; 
	...
	float miniRelIsoChg_2 = (*_daughters_miniRelIsoChg_2)[i_daughter]; //rel
        float miniRelIsoAll_2 = (*_daughters_miniRelIsoAll_2)[i_daughter]; //rel
        float miniRelIsoNeutr_2 = miniRelIsoAll_2 - miniRelIsoChg_2; // rel
        float PFRelIsoAll04_2 = (*_daughters_PFRelIsoAll04_2)[i_daughter]; //relative
        float PFRelIsoAll_2 = (*_daughters_PFRelIsoAll_2)[i_daughter]; //relative
        float sip = (*_SIP)[i_daughter];
	float eleMVA = (*_daughters_eleMVAnt)[i_daughter];
        //new 2017 working point: taken directly from mvaEleID-Fall17-noIso-V1-wpLoose
        bool LooseIdWP = (*_daughters_iseleWPLoose)[i_daughter]; 
	int eleMissingHits = (*_daughters_eleMissingHits)[i_daughter];
	
	if(daughter.Pt()>7 && fabs(daughter.Eta())<2.5 && fabs(dxy)<=0.05 && fabs(dz)<0.1 && miniRelIsoAll_2<0.4 && sip < 8 && LooseIdWP && eleMissingHits<=1){
	  ...
	  lepMVA_jetNDauChargedMVASel = (*_daughters_jetNDauChargedMVASel_2)[i_daughter]; //from nanoAOD
          lepMVA_miniRelIsoCharged = miniRelIsoChg_2; // from nanoAOD
          lepMVA_miniRelIsoNeutral = miniRelIsoAll_2 - miniRelIsoChg_2; //from nanoAOD
 
	  lepMVA_jetPtRel   = 0.; 
	  lepMVA_jetPtRatio = 1.;      
          
          if(_daughters_dR_closest_jet[i_daughter]<0.4){   
	    lepMVA_jetPtRel   = (*_daughters_jetPtRel_2)[i_daughter]; 
	    lepMVA_jetPtRatio = std::min((*_daughters_jetPtRatio_2)[i_daughter],float(1.5)); 
	  }
          else{
            lepMVA_jetPtRel  = 0. ;
            lepMVA_jetPtRatio = 1 / ( 1 + PFRelIsoAll04_2 ); 
          }
    ...
    for(unsigned int i_ele=0; i_ele<reco_eles.size(); i_ele++){
      ...
      _recoele_jetNDauChargedMVASel_2.push_back( (*_daughters_jetNDauChargedMVASel_2)[i_daughter] );
      _recoele_PFRelIsoAll_2.push_back( (*_daughters_PFRelIsoAll_2)[i_daughter] );
      _recoele_PFRelIsoAll04_2.push_back( (*_daughters_PFRelIsoAll04_2)[i_daughter] );
      _recoele_miniIsoCharged.push_back( elec.Pt()*(*_daughters_miniRelIsoCharged)[i_daughter] );
      _recoele_miniRelIsoAll_2.push_back( (*_daughters_miniRelIsoAll_2)[i_daughter] );
      _recoele_miniIsoChg_2.push_back( elec.Pt()*(*_daughters_miniRelIsoChg_2)[i_daughter] );      
      _recoele_PFIsoChg_2.push_back( elec.Pt()*(*_daughters_PFRelIsoChg_2)[i_daughter] );
      _recoele_miniIsoNeutral.push_back( elec.Pt()*(*_daughters_miniRelIsoNeutral)[i_daughter] );
      _recoele_miniIsoNeutr_2.push_back( elec.Pt()*(((*_daughters_miniRelIsoAll_2)[i_daughter]) - (*_daughters_miniRelIsoChg_2)[i_daughter]));
      _recoele_PFIsoNeutr_2.push_back( elec.Pt()*(((*_daughters_PFRelIsoAll_2)[i_daughter]) - (*_daughters_PFRelIsoChg_2)[i_daughter]));
	...
	_recoele_jetPtRel_2.push_back( (*_daughters_jetPtRel_2)[i_daughter] );
	_recoele_jetPtRatio.push_back( std::min((*_daughters_jetPtRatio)[i_daughter],float(1.5)) );
        _recoele_jetPtRatio_2.push_back( std::min((*_daughters_jetPtRatio_2)[i_daughter],float(1.5)) );
      }
      else{
	_recoele_jetPtRel.push_back( 0. );
	_recoele_jetPtRel_2.push_back( 0. );
	_recoele_jetPtRatio.push_back( 1 / ( 1 + (*_daughters_PFRelIsoAll04_2)[i_daughter] ) ); 
        _recoele_jetPtRatio_2.push_back( 1 / ( 1 + (*_daughters_PFRelIsoAll04_2)[i_daughter] ) );
      }
      ...
      lepMVA_jetNDauChargedMVASel = _recoele_jetNDauChargedMVASel_2[i_ele];
      lepMVA_miniRelIsoCharged = _recoele_miniIsoChg_2[i_ele] / lepMVA_pt;
      lepMVA_miniRelIsoNeutral = _recoele_miniIsoNeutr_2[i_ele] / lepMVA_pt;
      lepMVA_jetPtRel  = _recoele_jetPtRel_2[i_ele]; 
      lepMVA_jetPtRatio = _recoele_jetPtRatio_2[i_ele];      
     ...
     // cout << "Here fill:conept="<<conept<<"recopt="<<elec.Pt()<<endl;
      ...
      //Fakeable 2017
      bool isfakeable=false;
      if(conept>10 && eleIDcut && eleMissingHits==0){ //removing passConversionVeto
	...
	_n_recoele_cutsel++;
      ...
      //MVA-based selection - to be updated for 2017
      bool ismvasel=false;
      if(conept>10 && eleIDcut && eleMissingHits==0 && _recoele_leptonMVA[i_ele]>0.9 && lepMVA_jetBTagDeepCSV<0.4941 && passConversionVeto) 
	ismvasel=true;
