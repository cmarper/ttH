...
void create_syncNtuple(){
  ...
  TString dir_in="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/";
  TString dir_out="/data_CMS/cms/mperez/ttH_2017/syncNtuples/";

  //TString file="syncNtuple_ttW_multilep.root";
  TString file="syncNtuple_ttH_v20.root";


  vector<TString> list;
  //list.push_back(dir_in+"syncNtuple_ttW_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");
  list.push_back(dir_in+"syncNtuple_94X_v20_0_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root");
  ...
  float _ele1_sigmaEtaEta; //NEW
  float _ele1_HoE; //NEW
  float _ele1_deltaEta; //NEW
  float _ele1_deltaPhi; // NEW
  float _ele1_OoEminusOoP; //NEW
  bool _ele1_isfakeablesel;
  bool _ele1_ismvasel;
  float _ele1_PFRelIso04; //NEW
  ...
  float _ele2_sigmaEtaEta; //NEW
  float _ele2_HoE; //NEW
  float _ele2_deltaEta; //NEW
  float _ele2_deltaPhi; // NEW
  float _ele2_OoEminusOoP; //NEW
  bool _ele2_isfakeablesel;
  bool _ele2_ismvasel;
  float _ele2_PFRelIso04; //NEW
  ...
  tree_new->Branch("MT_met_lep1",    &_MT_met_lep1,     "MT_met_lep1/F");
  ...
  tree->SetBranchAddress("recomu_jetNDauChargedMVASel_2", &_recomu_jetNDauChargedMVASel_2);
  tree->SetBranchAddress("recomu_miniRelIso",           &_recomu_miniRelIso);
  tree->SetBranchAddress("recomu_miniRelIsoAll_2",      &_recomu_miniRelIsoAll_2);
  tree->SetBranchAddress("recomu_miniIsoCharged",       &_recomu_miniIsoCharged);
  tree->SetBranchAddress("recomu_miniIsoChg_2",         &_recomu_miniIsoChg_2);
  tree->SetBranchAddress("recomu_miniIsoNeutral",       &_recomu_miniIsoNeutral);
  tree->SetBranchAddress("recomu_miniIsoNeutr_2",       &_recomu_miniIsoNeutr_2);
  tree->SetBranchAddress("recomu_jetPtRel",             &_recomu_jetPtRel);
  tree->SetBranchAddress("recomu_jetPtRel_2",           &_recomu_jetPtRel_2);
  tree->SetBranchAddress("recomu_jetPtRatio",           &_recomu_jetPtRatio);
  tree->SetBranchAddress("recomu_jetPtRatio_2",         &_recomu_jetPtRatio_2);
  ...
  tree->SetBranchAddress("recoele_jetNDauChargedMVASel_2",&_recoele_jetNDauChargedMVASel_2);
  tree->SetBranchAddress("recoele_miniRelIso",          &_recoele_miniRelIso);
  tree->SetBranchAddress("recoele_miniRelIsoAll_2",     &_recoele_miniRelIsoAll_2);
  tree->SetBranchAddress("recoele_miniIsoCharged",      &_recoele_miniIsoCharged);
  tree->SetBranchAddress("recoele_miniIsoChg_2",        &_recoele_miniIsoChg_2);
  tree->SetBranchAddress("recoele_miniIsoNeutral",      &_recoele_miniIsoNeutral);
  tree->SetBranchAddress("recoele_miniIsoNeutr_2",      &_recoele_miniIsoNeutr_2);
  tree->SetBranchAddress("recoele_PFRelIsoAll04_2",    	&_recoele_PFRelIsoAll04_2);
  tree->SetBranchAddress("recoele_jetPtRel",            &_recoele_jetPtRel);
  tree->SetBranchAddress("recoele_jetPtRel_2",          &_recoele_jetPtRel_2);
  tree->SetBranchAddress("recoele_jetPtRatio",          &_recoele_jetPtRatio);
  tree->SetBranchAddress("recoele_jetPtRatio_2",        &_recoele_jetPtRatio_2);
  ...
  tree->SetBranchAddress("recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017", &_recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
  ...
  tree->SetBranchAddress("recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017", &_recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
  tree->SetBranchAddress("recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017", &_recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017); 
  ...
  tree->SetBranchAddress("lep2_conept",&_lep2_conept);
  tree->SetBranchAddress("lep3_conept",&_lep3_conept);
  tree->SetBranchAddress("mindR_lep1_recoPFjet",&_mindr_lep1_jet);
  tree->SetBranchAddress("mindR_lep2_recoPFjet",&_mindr_lep2_jet);
  tree->SetBranchAddress("MT_lep1",&_MT_met_lep1);
  ...
  for (int i=0;i<nentries;i++) {
    ...
    _recomu_jetNDauChargedMVASel_2 = 0;
    _recomu_miniRelIso           = 0;
    _recomu_miniRelIsoAll_2      = 0;
    _recomu_miniIsoCharged       = 0;
    _recomu_miniIsoChg_2         = 0;
    _recomu_miniIsoNeutral       = 0;
    _recomu_miniIsoNeutr_2       = 0;
    _recomu_combreliso04         = 0;
    _recomu_jetPtRel             = 0;
    _recomu_jetPtRatio           = 0;
    _recomu_jetPtRel_2             = 0;
    _recomu_jetPtRatio_2           = 0;
    _recomu_jetCSV               = 0;
    _recomu_sip3D                = 0;
    _recomu_dxy                  = 0;
    _recomu_dz                   = 0;
    ...
    _recoele_jetNDauChargedMVASel_2 = 0;
    _recoele_miniRelIso            = 0;
    _recoele_miniRelIsoAll_2      = 0;
    _recoele_miniIsoCharged       = 0;
    _recoele_miniIsoChg_2         = 0;
    _recoele_miniIsoNeutral       = 0;
    _recoele_miniIsoNeutr_2       = 0;
    _recoele_PFRelIsoAll04_2         = 0;
    _recoele_jetPtRel             = 0;
    _recoele_jetPtRatio           = 0;
    _recoele_jetPtRel_2             = 0;
    _recoele_jetPtRatio_2           = 0;
    _recoele_jetCSV               = 0;
    _recoele_sip3D                = 0;
    _recoele_dxy                  = 0;
    _recoele_dz                   = 0;
    ...
    _recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017   = 0;
    ...
    _recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017   = 0;
    _recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017      = 0;
    ...
    if(_n_presel_mu>0){
      ...
      _mu1_jetNDauChargedMVASel = (*_recomu_jetNDauChargedMVASel_2)[0];
      _mu1_miniRelIso           = (*_recomu_miniRelIsoAll_2)[0];
      _mu1_miniIsoCharged       = (*_recomu_miniIsoChg_2)[0];
      _mu1_miniIsoNeutral       = (*_recomu_miniIsoNeutr_2)[0];
      _mu1_jetPtRel             = (*_recomu_jetPtRel_2)[0];
      _mu1_jetPtRatio           = (*_recomu_jetPtRatio_2)[0];
   ...
   if(_n_presel_mu>1){
      ...
      _mu2_jetNDauChargedMVASel = (*_recomu_jetNDauChargedMVASel_2)[1];
      _mu2_miniRelIso           = (*_recomu_miniRelIsoAll_2)[1];
      _mu2_miniIsoCharged       = (*_recomu_miniIsoChg_2)[1];
      _mu2_miniIsoNeutral       = (*_recomu_miniIsoNeutr_2)[1];
      _mu2_jetPtRel             = (*_recomu_jetPtRel_2)[1];
      _mu2_jetPtRatio           = (*_recomu_jetPtRatio_2)[1];
    ...
    if(_n_presel_ele>0){
      ...
      _ele1_jetNDauChargedMVASel = (*_recoele_jetNDauChargedMVASel_2)[0];
      _ele1_miniRelIso           = (*_recoele_miniRelIsoAll_2)[0];
      _ele1_miniIsoCharged       = (*_recoele_miniIsoChg_2)[0];
      _ele1_miniIsoNeutral       = (*_recoele_miniIsoNeutr_2)[0];
      _ele1_jetPtRel             = (*_recoele_jetPtRel_2)[0];
      _ele1_jetPtRatio           = (*_recoele_jetPtRatio_2)[0];
      ...
      _ele1_PFRelIso04           = (*_recoele_PFRelIsoAll04_2)[0];
    }
    ...
    if(_n_presel_ele>1){
      ...
      _ele2_jetNDauChargedMVASel = (*_recoele_jetNDauChargedMVASel_2)[1];
      _ele2_miniRelIso           = (*_recoele_miniRelIsoAll_2)[1];
      _ele2_miniIsoCharged       = (*_recoele_miniIsoChg_2)[1];
      _ele2_miniIsoNeutral       = (*_recoele_miniIsoNeutr_2)[1];
      _ele2_jetPtRel             = (*_recoele_jetPtRel_2)[1];
      _ele2_jetPtRatio           = (*_recoele_jetPtRatio_2)[1];
      ...
      _ele2_PFRelIso04           = (*_recoele_PFRelIsoAll04_2)[1];
    }
    ...
    if(_n_presel_tau>0){
      ...
      _tau1_byVLooseIsolationMVArun2v1DBdR03oldDMwLT         = (*_recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[0];
      _tau1_byLooseIsolationMVArun2v1DBdR03oldDMwLT          = (*_recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[0];
      _tau1_byMediumIsolationMVArun2v1DBdR03oldDMwLT         = (*_recotauh_byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[0];
      _tau1_byTightIsolationMVArun2v1DBdR03oldDMwLT          = (*_recotauh_byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[0];
      _tau1_byVTightIsolationMVArun2v1DBdR03oldDMwLT         = (*_recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[0];
      _tau1_rawMVArun2v1DBdR03oldDMwLT                       = (*_recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017)[0];
    ...
    if(_n_presel_tau>1){
      ...
      _tau2_byVLooseIsolationMVArun2v1DBdR03oldDMwLT         = (*_recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[1];
      _tau2_byLooseIsolationMVArun2v1DBdR03oldDMwLT          = (*_recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[1];
      _tau2_byMediumIsolationMVArun2v1DBdR03oldDMwLT         = (*_recotauh_byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[1];
      _tau2_byTightIsolationMVArun2v1DBdR03oldDMwLT          = (*_recotauh_byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[1];
      _tau2_byVTightIsolationMVArun2v1DBdR03oldDMwLT         = (*_recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[1];
      _tau2_rawMVArun2v1DBdR03oldDMwLT                       = (*_recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017)[1];
    ...
    if(_n_presel_jet>0){
      ...
      _jet1_CSV  = (*_recoPFJet_DeepCSVscore)[0];
    ...
    if(_n_presel_jet>1){
      ...
      _jet2_CSV  = (*_recoPFJet_DeepCSVscore)[1];
    }
    ...
    if(_n_presel_jet>2){
      ...
      _jet3_CSV  = (*_recoPFJet_DeepCSVscore)[2];
    ...
    if(_n_presel_jet>3){
      ...
      _jet4_CSV  = (*_recoPFJet_DeepCSVscore)[3];
...
void create_syncNtuple_eventbased_ttH_tautau(){
  ...
  TString file="syncNtuple_event_ttH_tautau_v4.root";    
  ...
  //list.push_back(dir_in+"syncNtuple_splitted.root");
  list.push_back(dir_in+"syncNtuple_splitted_v4.root");
  ...
  for(unsigned int i=0;i<tree.size();i++){
    ...
    tree[i]->SetBranchAddress("recomu_jetNDauChargedMVASel_2", &_recomu_jetNDauChargedMVASel_2);
    tree[i]->SetBranchAddress("recomu_miniRelIso",           &_recomu_miniRelIso);
    tree[i]->SetBranchAddress("recomu_miniRelIsoAll_2",      &_recomu_miniRelIsoAll_2);
    tree[i]->SetBranchAddress("recomu_miniIsoCharged",       &_recomu_miniIsoCharged);
    tree[i]->SetBranchAddress("recomu_miniIsoChg_2",         &_recomu_miniIsoChg_2);
    tree[i]->SetBranchAddress("recomu_miniIsoNeutral",       &_recomu_miniIsoNeutral);
    tree[i]->SetBranchAddress("recomu_miniIsoNeutr_2",       &_recomu_miniIsoNeutr_2);
    tree[i]->SetBranchAddress("recomu_jetPtRel",             &_recomu_jetPtRel);
    tree[i]->SetBranchAddress("recomu_jetPtRatio",           &_recomu_jetPtRatio);
    tree[i]->SetBranchAddress("recomu_jetPtRel_2",             &_recomu_jetPtRel_2);
    tree[i]->SetBranchAddress("recomu_jetPtRatio_2",           &_recomu_jetPtRatio_2);
    ...
    tree[i]->SetBranchAddress("recoele_jetNDauChargedMVASel_2",&_recoele_jetNDauChargedMVASel_2);
    tree[i]->SetBranchAddress("recoele_miniRelIso",           &_recoele_miniRelIso);
    tree[i]->SetBranchAddress("recoele_miniRelIsoAll_2",      &_recoele_miniRelIsoAll_2);
    tree[i]->SetBranchAddress("recoele_miniIsoCharged",       &_recoele_miniIsoCharged);
    tree[i]->SetBranchAddress("recoele_miniIsoChg_2",         &_recoele_miniIsoChg_2);
    tree[i]->SetBranchAddress("recoele_miniIsoNeutral",       &_recoele_miniIsoNeutral);
    tree[i]->SetBranchAddress("recoele_miniIsoNeutr_2",       &_recoele_miniIsoNeutr_2);
    tree[i]->SetBranchAddress("recoele_jetPtRel",            &_recoele_jetPtRel);
    tree[i]->SetBranchAddress("recoele_jetPtRatio",          &_recoele_jetPtRatio);
    tree[i]->SetBranchAddress("recoele_jetPtRel",            &_recoele_jetPtRel_2);
    tree[i]->SetBranchAddress("recoele_jetPtRatio",          &_recoele_jetPtRatio_2);
    ...
    tree[i]->SetBranchAddress("recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017", &_recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
    tree[i]->SetBranchAddress("recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017", &_recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
    tree[i]->SetBranchAddress("recotauh_byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017", &_recotauh_byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
    tree[i]->SetBranchAddress("recotauh_byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017", &_recotauh_byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
    tree[i]->SetBranchAddress("recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017", &_recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
    tree[i]->SetBranchAddress("recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017", &_recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017);
...
void create_syncNtuple_eventbased_ttH_tautau_MEM(){
  ...
  for(unsigned int i=0;i<tree.size();i++){
    ...
    tree[i]->SetBranchAddress("recoele_miniIsoNeutr_2",       &_recoele_miniIsoNeutr_2);
    tree[i]->SetBranchAddress("recoele_jetPtRel",             &_recoele_jetPtRel);
    tree[i]->SetBranchAddress("recoele_jetPtRel_2",           &_recoele_jetPtRel_2);
    tree[i]->SetBranchAddress("recoele_jetPtRatio",          &_recoele_jetPtRatio);
    tree[i]->SetBranchAddress("recoele_jetPtRatio_2",        &_recoele_jetPtRatio_2);
    tree[i]->SetBranchAddress("recoele_jetCSV",              &_recoele_jetCSV);
    tree[i]->SetBranchAddress("recoele_sip3D",               &_recoele_sip3D);
    tree[i]->SetBranchAddress("recoele_dxy",                 &_recoele_dxy);
    tree[i]->SetBranchAddress("recoele_dz",                  &_recoele_dz);
