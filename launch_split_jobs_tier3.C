...
/*
  for(unsigned int j=0;j<5;j++){
    ...
    myscript << ".L tree_splitter_2017_v1.C+\n";
...
/*
 ...
 for(unsigned int j=0;j<11;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<11;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_JECup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<11;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_JECdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<11;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_TESup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<11;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_TESdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_THW_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_THW_ICHEP18_JECup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_THW_ICHEP18_JECdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_THW_ICHEP18_TESup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_THW_ICHEP18_TESdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<6;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<6;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_JECup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<6;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_JECdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<6;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_TESup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<6;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_TESdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<4;j++){
  ...
  for(unsigned int j=0;j<3;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<3;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_JECup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<3;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_JECdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<3;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_TESup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<3;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_TESdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<70;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleEG_2016B_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<52;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleEG_2016C_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<58;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleEG_2016D_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<52;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleEG_2016E_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<38;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleEG_2016F_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<83;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleEG_2016G_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<89;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleEG_2016Hv2_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<3;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleEG_2016Hv3_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<83;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleMu_2016B_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<29;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleMu_2016C_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<36;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleMu_2016D_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<40;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleMu_2016E_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<21;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleMu_2016F_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<46;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleMu_2016G_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
...
for(unsigned int j=0;j<49;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleMu_2016Hv2_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DoubleMu_2016Hv3_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<32;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_MuonEG_2016B_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<15;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_MuonEG_2016C_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<24;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_MuonEG_2016D_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<22;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_MuonEG_2016E_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<18;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_MuonEG_2016F_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<34;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_MuonEG_2016G_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<29;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_MuonEG_2016Hv2_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<1;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_MuonEG_2016Hv3_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<80;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleMu_2016B_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<79;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleMu_2016C_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<53;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleMu_2016D_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<48;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleMu_2016E_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<80;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleMu_2016F_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<80;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleMu_2016G_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<92;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleMu_2016Hv2_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<6;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleMu_2016Hv3_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<84;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleEle_2016B_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<55;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleEle_2016C_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<84;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleEle_2016D_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<65;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleEle_2016E_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<89;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleEle_2016F_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<84;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleEle_2016G_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<66;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleEle_2016Hv2_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<4;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_SingleEle_2016Hv3_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<7;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttbar_DL_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<25;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttbar_DL_ext_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<13;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttbar_SLfromT_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<49;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ttbar_SLfromTbar_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<1;j++){
  ...
  for(unsigned int j=0;j<1;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_WW_DoubleScatt_80X_reHLT_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<15;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ZG_80X_reHLT_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<15;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ZG_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<6;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_WG_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_ZZJJ_80X_reHLT_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_JECup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_JECdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_TESup_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_TESdown_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<1;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_tG_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
 ...
 for(unsigned int j=0;j<2;j++){
    ...
    TString ScriptName = Form("script_tier3_MC_split/split_DYBJets_ICHEP18_%i.sh",j);
    ofstream myscript;
    myscript.open (ScriptName.Data());
    myscript << "#!/bin/bash\n";
    myscript << "cd /home/llr/cms/strebler/CMSSW_8_0_20/src/\n";
...
/*
  ...
  /*for(unsigned int j=0;j<11;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<11;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_JECup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<11;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_JECdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<11;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_TESup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<11;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttHJet_Hnonbb_ICHEP18_TESdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_THW_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_THW_ICHEP18_JECup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_THW_ICHEP18_JECdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_THW_ICHEP18_TESup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_THW_ICHEP18_TESdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
...
*/
  ...
  /*for(unsigned int j=0;j<6;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<6;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_JECup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<6;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_JECdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<6;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_TESup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<6;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttZ_ext_ICHEP18_TESdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<70;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleEG_2016B_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<52;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleEG_2016C_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<58;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleEG_2016D_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<52;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleEG_2016E_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<37;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleEG_2016F_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<83;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleEG_2016G_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<89;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleEG_2016Hv2_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<3;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleEG_2016Hv3_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<83;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleMu_2016B_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<29;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleMu_2016C_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<36;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleMu_2016D_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<28;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleMu_2016E_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<21;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleMu_2016F_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<46;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleMu_2016G_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<49;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleMu_2016Hv2_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DoubleMu_2016Hv3_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<32;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_MuonEG_2016B_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<15;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_MuonEG_2016C_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<24;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_MuonEG_2016D_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<22;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_MuonEG_2016E_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<17;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_MuonEG_2016F_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<34;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_MuonEG_2016G_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<29;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_MuonEG_2016Hv2_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<1;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_MuonEG_2016Hv3_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<80;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleMu_2016B_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<79;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleMu_2016C_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<53;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleMu_2016D_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<48;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleMu_2016E_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<36;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleMu_2016F_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<80;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleMu_2016G_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<92;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleMu_2016Hv2_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleMu_2016Hv3_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<84;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleEle_2016B_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<55;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleEle_2016C_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<84;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleEle_2016D_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<65;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleEle_2016E_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<39;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleEle_2016F_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<84;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleEle_2016G_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
   ...
   /*for(unsigned int j=0;j<66;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleEle_2016Hv2_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_SingleEle_2016Hv3_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<3;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<3;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_JECup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<3;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_JECdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<3;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_TESup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<3;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttW_ext_ICHEP18_TESdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<7;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttbar_DL_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<25;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttbar_DL_ext_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<13;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttbar_SLfromT_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<49;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ttbar_SLfromTbar_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<1;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_WW_DoubleScatt_80X_reHLT_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<15;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ZG_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_ZZJJ_80X_reHLT_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<6;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_WG_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_JECup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_JECdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_TESup_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_WZ_powheg_ICHEP18_TESdown_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  for(unsigned int j=0;j<1;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_tG_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
  ...
  /*for(unsigned int j=0;j<2;j++){
    ...
    TString LaunchExec = "/opt/exp_soft/cms/t3/t3submit ";
    LaunchExec += Form("script_tier3_MC_split/split_DYBJets_ICHEP18_%i.sh",j);
    gSystem->Exec(LaunchExec.Data());
