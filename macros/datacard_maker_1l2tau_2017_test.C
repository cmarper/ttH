...
float XS_ttbar_SLfromT = 365.34; //SL semileptonic
float XS_ttbar_SLfromTbar = 365.34;
...
TString filename_ZZZ = "/data_CMS/cms/mperez/ttH__2017/ntuples_splitted/nominal/Rares/HTauTauTree_ZZZ_split_withPU.root";
...
//FIXME TString filename_WpWp = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/Rares/HTauTauTree_WpWp_split_PU.root";
...
TString filename_ttZ_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/ttV/HTauTauTree_ttZ_split_JECup_PU.root";
TString filename_ttZ_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/ttV/HTauTauTree_ttZ_split_JECdown_PU.root";
TString filename_ttZ_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/ttV/HTauTauTree_ttZ_split_TESup_PU.root";
TString filename_ttZ_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/ttV/HTauTauTree_ttZ_split_TESdown_PU.root";


TString filename_ttW_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/ttV/HTauTauTree_ttW_*split_JECup_PU.root";
TString filename_ttW_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/ttV/HTauTauTree_ttW_*split_JECdown_PU.root";
TString filename_ttW_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/ttV/HTauTauTree_ttW_*split_TESup_PU.root";
TString filename_ttW_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/ttV/HTauTauTree_ttW_*split_TESdown_PU.root";

TString filename_WZ_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/EWK/HTauTauTree_WZ_split_JECup_PU.root";
TString filename_WZ_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/EWK/HTauTauTree_WZ_split_JECdown_PU.root";
TString filename_WZ_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/EWK/HTauTauTree_WZ_split_TESup_PU.root";
TString filename_WZ_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/EWK/HTauTauTree_WZ_split_TESdown_PU.root";

TString filename_WWW_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/Rares/HTauTauTree_WWW_split_JECup_PU.root";
TString filename_WWW_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/Rares/HTauTauTree_WWW_split_JECdown_PU.root";
TString filename_WWW_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/Rares/HTauTauTree_WWW_split_TESup_PU.root";
TString filename_WWW_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/Rares/HTauTauTree_WWW_split_TESdown_PU.root";

TString filename_WWZ_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/Rares/HTauTauTree_WWZ_split_JECup_PU.root";
TString filename_WWZ_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/Rares/HTauTauTree_WWZ_split_JECdown_PU.root";
TString filename_WWZ_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/Rares/HTauTauTree_WWZ_split_TESup_PU.root";
TString filename_WWZ_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/Rares/HTauTauTree_WWZ_split_TESdown_PU.root";

TString filename_WZZ_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/Rares/HTauTauTree_WZZ_split_JECup_PU.root";
TString filename_WZZ_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/Rares/HTauTauTree_WZZ_split_JECdown_PU.root";
TString filename_WZZ_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/Rares/HTauTauTree_WZZ_split_TESup_PU.root";
TString filename_WZZ_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/Rares/HTauTauTree_WZZ_split_TESdown_PU.root";

TString filename_ZZZ_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/Rares/HTauTauTree_ZZZ_split_JECup_PU.root";
TString filename_ZZZ_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/Rares/HTauTauTree_ZZZ_split_JECdown_PU.root";
TString filename_ZZZ_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/Rares/HTauTauTree_ZZZ_split_TESup_PU.root";
TString filename_ZZZ_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/Rares/HTauTauTree_ZZZ_split_TESdown_PU.root";

TString filename_WpWp_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/Rares/HTauTauTree_WpWp_split_JECup_PU.root";
TString filename_WpWp_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/Rares/HTauTauTree_WpWp_split_JECdown_PU.root";
TString filename_WpWp_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/Rares/HTauTauTree_WpWp_split_TESup_PU.root";
TString filename_WpWp_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/Rares/HTauTauTree_WpWp_split_TESdown_PU.root";

TString filename_tZq_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/Rares/HTauTauTree_tZq_split_JECup_PU_newtrig.root";
TString filename_tZq_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/Rares/HTauTauTree_tZq_split_JECdown_PU_newtrig.root";
TString filename_tZq_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/Rares/HTauTauTree_tZq_split_TESup_PU_newtrig.root";
TString filename_tZq_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/Rares/HTauTauTree_tZq_split_TESdown_PU_newtrig.root";
...
void datacard_maker(TString var, int nbin, float xmin, float xmax,
  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TH1F* h_MC;
      if(filename_MC[i_MC].Contains("ttH_2017"))
	h_MC = single_plot(filename_MC[i_MC],
			       "HTauTauTree_1l_2tau",
			       var,
			       Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])*(category==%i && isTrig_1l &&",cat[i_cat]) + MC_sample_cut[i_MC] + ")",
			       nbin,xmin,xmax);
      else if(filename_MC[i_MC].Contains("ttH_2017"))
	h_MC = single_plot(filename_MC[i_MC],
			       "HTauTauTree_1l_2tau",
			       var,
			       Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])*(category==%i && isTrig_1l &&",cat[i_cat]) + MC_sample_cut[i_MC] + ")",
	...
	h_MC_genmatch = single_plot(filename_MC[i_MC],
				    ...
				    var,
				    Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])*event_weight_ttH*(category==%i && isGenMatched && ",cat_fakes[i_cat]) + MC_sample_cut[i_MC] + ")",
				    nbin,xmin,xmax);
      else if(filename_MC[i_MC].Contains("ttH_2017"))  
	h_MC_genmatch = single_plot(filename_MC[i_MC],
				    "HTauTauTree_1l_2tau_fake_CR",
    ...
    TH1F* h_fakes =single_plot(filename_data,
			       "HTauTauTree_1l_2tau_fake_CR",
			       var,
			       Form("event_weight_ttH*(category==%i)",cat_fakes[i_cat]),
			       nbin,xmin,xmax);

        
    h_fakes->Scale(luminosity/41298.); //Data files for 12.9 fb-1
	...
	TString cut = "MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])*bTagSF_CSVshape_weight_" + bTag_syst_names[i_b];
	if(filename_MC[i_MC].Contains("ttH_2017"))
	  cut = "MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])*bTagSF_CSVshape_weight_" + bTag_syst_names[i_b];
	cut+=Form("*(category==%i &&",cat[i_cat]) + MC_sample_cut[i_MC] + ")";
	...
	syst_name+="ttW";      
      ...
      TString cut = "PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])";
      if(filename_MC[i_MC].Contains("ttH_2017"))
	cut = "PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])";
      cut+=Form("*(category==%i && ",cat[i_cat]) + MC_sample_cut_thu_unc[i_MC] + ")";
   ...
   /* for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TString cut = "MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])";
      cut+=Form("*(category==%i && ",cat[i_cat]) + MC_sample_cut[i_MC] + ")";
...
void datacard_maker_njet_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/datacard_njet_1l2tau_syst_41p298fb_190618.root";
...
void datacard_maker_mvis_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/datacard_mvis_1l2tau_syst_12.9fb_112017.root";
