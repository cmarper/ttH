...
//FIXME TString filename_ZZ = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/EWK/HTauTauTree_ZZ_split_withPU.root";
...
//FIXME TString filename_norm_TTTT = "/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Rares/ntuple_PU_TTTT.root";
...
//FIXME TString filename_ZZ_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/EWK/HTauTauTree_ZZ_split_withPU_JECup.root";
//FIXME TString filename_ZZ_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/EWK/HTauTauTree_ZZ_split_withPU_JECdown.root";
//FIXME TString filename_ZZ_TESup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESup/EWK/HTauTauTree_ZZ_split_withPU_TESup.root";
//FIXME TString filename_ZZ_TESdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/TESdown/EWK/HTauTauTree_ZZ_split_withPU_TESdown.root";
  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TH1F* h_MC = single_plot(filename_MC[i_MC],
			       "HTauTauTree_1l_2tau",
			       var,
			       Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*(1-0.1*recotauh_sel_isGenMatched[0])*(1-0.1*recotauh_sel_isGenMatched[1])*(category==%i &&",cat[i_cat]) + MC_sample_cut[i_MC] + " && " + cut_cat + ")",
			       nbin,xmin,xmax);
    ...
    h_TTZ->Add( (TH1F*)f_new->Get("x_ttG") );
    ...
    h_data_obs->Scale(luminosity/41298.); 
...
void datacard_maker_mvis_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_mvis_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_mvis_1l2tau_syst_pt30(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_mvis_1l2tau_syst_36.8fb_pt30_180620.root";
...
void datacard_maker_mvis_1l2tau_syst_10bins(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_mvis_1l2tau_syst_36.8fb_180620_10bins.root";
...
void datacard_maker_n_fakelep_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_fakelep_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_n_fakeele_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_fakeele_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_n_fakemu_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_fakemu_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_n_faketau_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_faketau_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_n_jet_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_jet_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_n_jet_CSVloose_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_jet_CSVloose_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_n_jet_CSVmedium_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_jet_CSVmedium_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_ETmiss_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_ETmiss_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_lep_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_lep_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_mu_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_mu_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_ele_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_ele_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_tau1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_tau1_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_tau2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_tau2_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_jet1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_jet1_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_jet2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_jet2_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_bjet1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_bjet1_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_pT_bjet2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_bjet2_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_CSV_jet1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_DeepCSV_jet1_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_CSV_jet2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_DeepCSV_jet2_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_mltau_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_mltau_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_nvtx_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_nvtx_1l2tau_syst_36.8fb_180620.root";
...
void datacard_maker_all(){
  ...
  datacard_maker_mvis_1l2tau_syst();
  ...
  datacard_maker_pT_mu_1l2tau();
  datacard_maker_pT_ele_1l2tau();
  ...
  datacard_maker_nvtx_1l2tau_syst();
