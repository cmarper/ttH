...
void create_syncNtuple(){
  ...
  TString file="syncNtuple_ttH_v4.root";


  vector<TString> list;
  //list.push_back(dir_in+"syncNtuple_ttW_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");
  //list.push_back(dir_in+"syncNtuple_ttH_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");
  list.push_back(dir_in+"syncNtuple_ttH_v4_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");
  ...
  tree->SetBranchAddress("recomu_miniIsoAll_2",         &_recomu_miniIsoAll_2);
  ...
  tree->SetBranchAddress("recoele_miniIsoAll_2",        &_recoele_miniIsoAll_2);
  ...
  for (int i=0;i<nentries;i++) {
    ...
    if(_n_presel_mu>0){
      ...
      _mu0_miniRelIso           = (*_recomu_miniIsoAll_2)[0] / _mu0_pt;
      _mu0_miniIsoCharged       = (*_recomu_miniIsoChg_2)[0];
      _mu0_miniIsoNeutral       = ( (*_recomu_miniIsoAll_2)[0] - (*_recomu_miniIsoChg_2)[0] );
    ...
    if(_n_presel_mu>1){
      ...
      _mu1_miniRelIso           = (*_recomu_miniIsoAll_2)[1] / _mu1_pt;
      _mu1_miniIsoCharged       = (*_recomu_miniIsoChg_2)[1] ;
      _mu1_miniIsoNeutral       = ( (*_recomu_miniIsoAll_2)[1] - (*_recomu_miniIsoChg_2)[1] );
    ...
    if(_n_presel_ele>0){
      ...
      _ele0_miniRelIso           = (*_recoele_miniIsoAll_2)[0] / _ele0_pt;
      _ele0_miniIsoCharged       = (*_recoele_miniIsoChg_2)[0];
      _ele0_miniIsoNeutral       = ( (*_recoele_miniIsoAll_2)[0] - (*_recoele_miniIsoChg_2)[0] );
    ...
    if(_n_presel_ele>1){
      ...
      _ele0_miniRelIso           = (*_recoele_miniIsoAll_2)[1] / _ele1_pt;
      _ele0_miniIsoCharged       = (*_recoele_miniIsoChg_2)[1];
      _ele0_miniIsoNeutral       = ( (*_recoele_miniIsoAll_2)[1] - (*_recoele_miniIsoChg_2)[1] );
    ...
    if(_n_presel_jet>0){
      ...
      _jet0_CSV  = (*_recoPFJet_DeepCSVscore)[0];
    ...
    if(_n_presel_jet>1){
      ...
      _jet1_CSV  = (*_recoPFJet_DeepCSVscore)[1];
    }
    ...
    if(_n_presel_jet>2){
      ...
      _jet2_CSV  = (*_recoPFJet_DeepCSVscore)[2];
    ...
    if(_n_presel_jet>3){
      ...
      _jet3_CSV  = (*_recoPFJet_DeepCSVscore)[3];
