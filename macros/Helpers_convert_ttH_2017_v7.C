...
TString getInputFile(TString _sample){
     
     TString _inputFile;

     if (_sample == "DYJets_M10to50_ICHEP18") _inputFile = "PU_weights_2017/DYJets_M10to50.txt";
     else if (_sample == "DYJets_M50_ICHEP18") _inputFile = "PU_weights_2017/DYJets_M50.txt";
     else if (_sample == "DYJets_M50_ext_ICHEP18") _inputFile = "PU_weights_2017/DYJets_M50_ext.txt";
     else if (_sample == "GluGluH_ICHEP18") _inputFile = "PU_weights_2017/ggHZZ4l.txt";
     else if (_sample == "ST_sLep_ICHEP18") _inputFile = "PU_weights_2017/ST_sLep.txt";
     else if (_sample == "ST_sLep_psw_ICHEP18") _inputFile = "PU_weights_2017/ST_sLep_psw.txt";
     else if (_sample == "ST_tT_ICHEP18") _inputFile = "PU_weights_2017/ST_tT.txt";
     else if (_sample == "ST_tTbar_ICHEP18") _inputFile = "PU_weights_2017/ST_tTbar.txt";
     else if (_sample == "ST_tWT_ICHEP18") _inputFile = "PU_weights_2017/ST_tWT.txt";
     else if (_sample == "ST_tWTbar_ICHEP18") _inputFile = "PU_weights_2017/ST_tWTbar.txt";
     else if (_sample == "ttG_ICHEP18") _inputFile = "PU_weights_2017/TTGJets.txt";
     else if (_sample == "ttHJet_Tobb_ICHEP18") _inputFile = "PU_weights_2017/ttHJetTobb.txt";
     else if (_sample == "ttHJet_Hnonbb_ICHEP18") _inputFile = "PU_weights_2017/ttHJetToNonbb.txt";
     else if (_sample == "ttH_ToNonbb_ICHEP18") _inputFile = "PU_weights_2017/ttHToNonbb.txt";
     else if (_sample == "TTLeptons_ICHEP18") _inputFile = "PU_weights_2017/TTToDiLep.txt";
     else if (_sample == "TTLeptons_psw_ICHEP18") _inputFile = "PU_weights_2017/TTToDiLep_psw.txt";
     else if (_sample == "TTHad_ICHEP18") _inputFile = "PU_weights_2017/TTToHad.txt";
     else if (_sample == "TTHad_psw_ICHEP18") _inputFile = "PU_weights_2017/TTToHad_psw.txt";
     else if (_sample == "TTSemileptonic_ICHEP18") _inputFile = "PU_weights_2017/TTToSemiLep.txt";
     else if (_sample == "TTSemileptonic_psw_ICHEP18") _inputFile = "PU_weights_2017/TTToSemiLep_psw.txt";
     else if (_sample == "TTTT_ICHEP18") _inputFile = "PU_weights_2017/TTTT.txt";
     else if (_sample == "ttW_ICHEP18") _inputFile = "PU_weights_2017/TTW.txt";
     else if (_sample == "ttW_psw_ICHEP18") _inputFile = "PU_weights_2017/TTW_psw.txt";
     else if (_sample == "ttWW_ICHEP2018") _inputFile = "PU_weights_2017/TTWW.txt";
     else if (_sample == "ttZ_ICHEP18") _inputFile = "PU_weights_2017/TTZ.txt";
     else if (_sample == "ttZ_lowmass_ICHEP18") _inputFile = "PU_weights_2017/TTZ_M1to10.txt";
     else if (_sample == "tZq_ICHEP18") _inputFile = "PU_weights_2017/tZq.txt";
     else if (_sample == "WJets_ICHEP18") _inputFile = "PU_weights_2017/WJets.txt";
     else if (_sample == "WW_ICHEP18") _inputFile = "PU_weights_2017/WW.txt";
     else if (_sample == "WW_DoubleScat_ICHEP18") _inputFile = "PU_weights_2017/WWds.txt";
     else if (_sample == "WWTo2L2Nuds_ICHEP18") _inputFile = "PU_weights_2017/WWTo2L2Nuds.txt";
     else if (_sample == "WWW_ICHEP18") _inputFile = "PU_weights_2017/WWW.txt";
     else if (_sample == "WWZ_ICHEP18") _inputFile = "PU_weights_2017/WWZ.txt";
     else if (_sample == "WZ_ICHEP18") _inputFile = "PU_weights_2017/WZ.txt";
     else if (_sample == "WZTo3LNu_ICHEP18") _inputFile = "PU_weights_2017/WZTo3LNu.txt";
     else if (_sample == "WZZ_ICHEP18") _inputFile = "PU_weights_2017/WZZ.txt";
     else if (_sample == "ZZ_ICHEP18") _inputFile = "PU_weights_2017/ZZ.txt";
     else if (_sample == "ZZ_ext_ICHEP18") _inputFile = "PU_weights_2017/ZZ_ext.txt";
     else if (_sample == "ZZZ_ICHEP18") _inputFile = "PU_weights_2017/ZZZ.txt";

     return _inputFile;
}

float getPUweight(int nPU, bool isMC, TString samplename)
{
    int nInt_file;
    float PUweight_file;
    float PU_weight = 0;
...
void convert_tree(TString sample, int iso_tau=0,
  ...
  if(sample=="ttHJet_Hnonbb_ICHEP18"){
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/ttHJetToNonbb_M125_TuneCP5_13TeV_amcatnloFXFX_madspin_pythia8_180514/ttHJetToNonbb_M125_TuneCP5_13TeV_amcatnloFXFX_madspin_pythia8/ttHJetToNonbb_M125_TuneCP5_13TeV_amcatnloFXFX_madspin_pythia8_180514/180514_193059/";
   ...
   // for(int i=0;i<1;i++){
  ...
  else if(sample=="GluGluH_ICHEP18"){
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/store/user/cmartinp/ttH/MC2017/GluGluHToZZTo4L_M125_13TeV_powheg2_JHUGenV7011_pythia8_v11_18052/GluGluHToZZTo4L_M125_13TeV_powheg2_JHUGenV7011_pythia8/GluGluHToZZTo4L_M125_13TeV_powheg2_JHUGenV7011_pythia8_v11_18052/180524_13052/";
...
/*
  else if(sample=="THQ_ICHEP18"){   //take sample from Marco
  ...
  */
  ...
  /*
  else if(sample=="THW_Moriond17"){ //take sample from Marco
  ...
  */
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/TTZToLLNuNu_M-10_TuneCP5_13TeV-amcatnlo-pythia8_180515/TTZToLLNuNu_M-10_TuneCP5_13TeV-amcatnlo-pythia8/TTZToLLNuNu_M-10_TuneCP5_13TeV-amcatnlo-pythia8_180515/180515_184841/";
  ...
  else if(sample=="ttZ_lowmass_ICHEP18"){
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/TTZToLL_M-1to10_TuneCP5_13TeV-amcatnlo-pythia8_180515/TTZToLL_M-1to10_TuneCP5_13TeV-amcatnlo-pythia8/TTZToLL_M-1to10_TuneCP5_13TeV-amcatnlo-pythia8_180515/180515_185251/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/TTWJetsToLNu_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8_180515/TTWJetsToLNu_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8/TTWJetsToLNu_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8_180515/180515_185552/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/TTWW_TuneCP5_13TeV-madgraph-pythia8_180515/TTWW_TuneCP5_13TeV-madgraph-pythia8/TTWW_TuneCP5_13TeV-madgraph-pythia8_180515/180515_190012/";
...
/*
  ...
  */
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8_180516/TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8/TTGJets_TuneCP5_13TeV-amcatnloFXFX-madspin-pythia8_180515/180516_073048/";
  ...
  /*
  else if(sample=="WpWp_Moriond17"){  //take from Marco
  ...
  */
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/ZZZ_TuneCP5_13TeV-amcatnlo-pythia8_180516/ZZZ_TuneCP5_13TeV-amcatnlo-pythia8/ZZZ_TuneCP5_13TeV-amcatnlo-pythia8_180516/180516_074544/";
    ...
    dir_out+="Rares/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/WWW_4F_TuneCP5_13TeV-amcatnlo-pythia8_180516/WWW_4F_TuneCP5_13TeV-amcatnlo-pythia8/WWW_4F_TuneCP5_13TeV-amcatnlo-pythia8_180516/180516_073943/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/WZZ_TuneCP5_13TeV-amcatnlo-pythia8_180516/WZZ_TuneCP5_13TeV-amcatnlo-pythia8/WZZ_TuneCP5_13TeV-amcatnlo-pythia8_180516/180516_074337/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/WWZ_4F_TuneCP5_13TeV-amcatnlo-pythia8_180516/WWZ_4F_TuneCP5_13TeV-amcatnlo-pythia8/WWZ_4F_TuneCP5_13TeV-amcatnlo-pythia8_180516/180516_074127/";
  ...
  else if(sample=="WW_DoubleScat_ICHEP18"){
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/WW_DoubleScattering_13TeV-pythia8_TuneCP5_180516/WW_DoubleScattering_13TeV-pythia8_TuneCP5/WW_DoubleScattering_13TeV-pythia8_TuneCP5_180516/180516_073503/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8_180515/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8/WZTo3LNu_TuneCP5_13TeV-amcatnloFXFX-pythia8_180515/180515_193834/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/WWTo2L2Nu_NNPDF31_TuneCP5_13TeV-powheg-pythia8_180515/WWTo2L2Nu_NNPDF31_TuneCP5_13TeV-powheg-pythia8/WWTo2L2Nu_NNPDF31_TuneCP5_13TeV-powheg-pythia8_180515/180515_193659/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/ZZTo4L_13TeV_powheg_pythia8_180515/ZZTo4L_13TeV_powheg_pythia8/ZZTo4L_13TeV_powheg_pythia8_180515/180515_194048/";
 ...
 */
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/TTTT_TuneCP5_13TeV-amcatnlo-pythia8_180516/TTTT_TuneCP5_13TeV-amcatnlo-pythia8/TTTT_TuneCP5_13TeV-amcatnlo-pythia8_180516/180516_074730/";
  ...
  else if(sample=="TTLeptons_ICHEP18"){
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_180515/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_180515/180515_195746/";
  ...
  else if(sample=="TTSemileptonic_ICHEP18"){
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/MC2017/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_180515/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8_180515/180515_200222/";
...
*/
 ...
 else if(sample=="DoubleEG_2017B_ICHEP18"){

    file="ntuple_DoubleEG_2017B";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleEG/2017B/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleEG_2017B_180514/DoubleEG/DoubleEG_2017B_180514/180514_091635/";
 ...
 else if(sample=="DoubleEG_2017C_ICHEP18"){

    file="ntuple_DoubleEG_2017C";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleEG/2017C/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleEG_2017C_180514/DoubleEG/DoubleEG_2017C_180514/180514_092143/";
 ...
 else if(sample=="DoubleEG_2017D_ICHEP18"){

    file="ntuple_DoubleEG_2017D";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleEG/2017D/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleEG_2017D_180514/DoubleEG/DoubleEG_2017D_180514/180514_092331/";
 ...
 else if(sample=="DoubleEG_2017E_ICHEP18"){

    file="ntuple_DoubleEG_2017E";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleEG/2017E/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleEG_2017E_180514/DoubleEG/DoubleEG_2017E_180514/180514_092617/";
 ...
 else if(sample=="DoubleEG_2017F_ICHEP18"){

    file="ntuple_DoubleEG_2017F";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleEG/2017F/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleEG_2017F_180514/DoubleEG/DoubleEG_2017F_180514/180514_092739/";
 ...
 else if(sample=="DoubleMu_2017B_ICHEP18"){

    file="ntuple_DoubleMu_2017B";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleMu/2017B/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleMuon_2017B_180514/DoubleMuon/DoubleMuon_2017B_180514/180514_093703/";
 ...
 else if(sample=="DoubleMu_2017C_ICHEP18"){

    file="ntuple_DoubleMu_2017C";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleMu/2017C/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleMuon_2017C_180514/DoubleMuon/DoubleMuon_2017C_180514/180514_093930/";
 ...
 else if(sample=="DoubleMu_2017D_ICHEP18"){

    file="ntuple_DoubleMu_2017D";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleMu/2017D/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleMuon_2017D_180514/DoubleMuon/DoubleMuon_2017D_180514/180514_094034/";
 ...
 else if(sample=="DoubleMu_2017E_ICHEP18"){

    file="ntuple_DoubleMu_2017E";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleMu/2017E/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleMuon_2017E_180514/DoubleMuon/DoubleMuon_2017E_180514/180514_094154/";
 ...
 else if(sample=="DoubleMu_2017F_ICHEP18"){

    file="ntuple_DoubleMu_2017F";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/DoubleMu/2017F/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleMuon_2017F_180514/DoubleMuon/DoubleMuon_2017F_180514/180514_094305/";
 ...
 else if(sample=="MuonEG_2017B_ICHEP18"){

    file="ntuple_MuonEG_2017B";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/MuonEG/2017B/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/MuonEG_2017B_180514/MuonEG/MuonEG_2017B_180514/180514_094812/";
 ...
 else if(sample=="MuonEG_2017C_ICHEP18"){

    file="ntuple_MuonEG_2017C";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/MuonEG/2017C/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/MuonEG_2017C_180514/MuonEG/MuonEG_2017C_180514/180514_095825/";
 ...
 else if(sample=="MuonEG_2017D_ICHEP18"){

    file="ntuple_MuonEG_2017D";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/MuonEG/2017D/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/MuonEG_2017D_180514/MuonEG/MuonEG_2017D_180514/180514_100046/";
 ...
 else if(sample=="MuonEG_2017E_ICHEP18"){

    file="ntuple_MuonEG_2017E";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/MuonEG/2017E/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/MuonEG_2017E_180514/MuonEG/MuonEG_2017E_180514/180514_100152/";
 ...
 else if(sample=="MuonEG_2017F_ICHEP18"){

    file="ntuple_MuonEG_2017F";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/MuonEG/2017F/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/MuonEG_2017F_180514/MuonEG/MuonEG_2017F_180514/180514_100348/";
    int i_dir=i_split/10;
 ...
 else if(sample=="SingleMu_2017B_ICHEP18"){

    file="ntuple_SingleMu_2017B";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleMu/2017B/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleMuon_2017B_180513/SingleMuon/SingleMuon_2017B_180513/180513_182918/";
 ...
 else if(sample=="SingleMu_2017C_ICHEP18"){

    file="ntuple_SingleMu_2017C";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleMu/2017C/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleMuon_2017C_180513/SingleMuon/SingleMuon_2017C_180513/180513_183359/";
 ...
 else if(sample=="SingleMu_2017D_ICHEP18"){

    file="ntuple_SingleMu_2017D";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleMu/2017D/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleMuon_2017D_180513/SingleMuon/SingleMuon_2017D_180513/180513_181510/";
 ...
 else if(sample=="SingleMu_2017E_ICHEP18"){

    file="ntuple_SingleMu_2017E";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleMu/2017E/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleMuon_2017E_180513/SingleMuon/SingleMuon_2017E_180513/180513_183605/";
 ...
 else if(sample=="SingleMu_2017F_ICHEP18"){

    file="ntuple_SingleMu_2017F";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleMu/2017F/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleMuon_2017F_180513/SingleMuon/SingleMuon_2017F_180513/180513_184059/";
 ...
 else if(sample=="SingleEle_2017B_ICHEP18"){

    file="ntuple_SingleEle_2017B";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleEle/2017B/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleElectron_2017B_180513_v2/SingleElectron/SingleEle_2017B_180513_v2/180513_154223/";
 ...
 else if(sample=="SingleEle_2017C_ICHEP18"){

    file="ntuple_SingleEle_2017C";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleEle/2017C/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleElectron_2017C_180513/SingleElectron/SingleEle_2017C_180513/180513_162556/";
 ...
 else if(sample=="SingleEle_2017D_ICHEP18"){

    file="ntuple_SingleEle_2017D";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleEle/2017D/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleElectron_2017D_180513/SingleElectron/SingleEle_2017D_180513/180513_162853/";
 ...
 else if(sample=="SingleEle_2017E_ICHEP18"){

    file="ntuple_SingleEle_2017E";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleEle/2017E/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleElectron_2017E_180513/SingleElectron/SingleEle_2017E_180513/180513_163152/";
 ...
 else if(sample=="SingleEle_2017F_ICHEP18"){

    file="ntuple_SingleEle_2017F";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/Data/SingleEle/2017F/";
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleElectron_2017F_180513/SingleElectron/SingleEle_2017F_180513/180513_163345/";
   ...
   file="syncNtuple_94X_v24_newfmw";
   dir_in="/data_CMS/cms/mperez/ttH_2017/ntuples_LLRHiggsTauTau/";
   //dir_in="~/ttH/2017/CMSSW_9_4_6/src/LLRHiggsTauTau/NtupleProducer/test/"; 
   dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/";
   //dir_out="~/ttH/2017/CMSSW_9_4_6/src/LLRHiggsTauTau/NtupleProducer/test/"; 
    ...
    dir_out+="ttH/";
   // list.push_back(dir_in+"HTauTauAnalysis_sync_v16_jetBTagDeepCSV_100events.root");
   list.push_back(dir_in+"HTauTauAnalysis_sync_v24_newfmw.root");
  }
  ...
  vector<float> *_daughters_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017;
  ...
  tree->SetBranchAddress("daughters_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017",&_daughters_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017);
  ...
  vector<int> _recotauh_byVLooseIsolationMVArun2017v2DBoldDMwLT2017;
  vector<int> _recotauh_byLooseIsolationMVArun2017v2DBoldDMwLT2017;
  vector<int> _recotauh_byMediumIsolationMVArun2017v2DBoldDMwLT2017;
  vector<int> _recotauh_byTightIsolationMVArun2017v2DBoldDMwLT2017;
  vector<int> _recotauh_byVTightIsolationMVArun2017v2DBoldDMwLT2017;
  vector<int> _recotauh_byVLooseIsolationMVArun2017v1DBoldDMwLT2017;
  vector<int> _recotauh_byLooseIsolationMVArun2017v1DBoldDMwLT2017;
  vector<int> _recotauh_byMediumIsolationMVArun2017v1DBoldDMwLT2017;
  vector<int> _recotauh_byTightIsolationMVArun2017v1DBoldDMwLT2017;
  vector<int> _recotauh_byVTightIsolationMVArun2017v1DBoldDMwLT2017;
  vector<int> _recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017;
  ...
  vector<int> _recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017;
  vector<float> _recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017;
  ...
  vector<int> _recoPFJet_untag_QGdiscr;
  ...
  tree_new->Branch("recotauh_byVLooseIsolationMVArun2017v2DBoldDMwLT2017",&_recotauh_byVLooseIsolationMVArun2017v2DBoldDMwLT2017);
  tree_new->Branch("recotauh_byLooseIsolationMVArun2017v2DBoldDMwLT2017",&_recotauh_byLooseIsolationMVArun2017v2DBoldDMwLT2017);
  tree_new->Branch("recotauh_byMediumIsolationMVArun2017v2DBoldDMwLT2017",&_recotauh_byMediumIsolationMVArun2017v2DBoldDMwLT2017);
  tree_new->Branch("recotauh_byTightIsolationMVArun2017v2DBoldDMwLT2017",&_recotauh_byTightIsolationMVArun2017v2DBoldDMwLT2017);
  tree_new->Branch("recotauh_byVTightIsolationMVArun2017v2DBoldDMwLT2017",&_recotauh_byVTightIsolationMVArun2017v2DBoldDMwLT2017);
  tree_new->Branch("recotauh_byVLooseIsolationMVArun2017v1DBoldDMwLT2017",&_recotauh_byVLooseIsolationMVArun2017v1DBoldDMwLT2017);
  tree_new->Branch("recotauh_byLooseIsolationMVArun2017v1DBoldDMwLT2017",&_recotauh_byLooseIsolationMVArun2017v1DBoldDMwLT2017);
  tree_new->Branch("recotauh_byMediumIsolationMVArun2017v1DBoldDMwLT2017",&_recotauh_byMediumIsolationMVArun2017v1DBoldDMwLT2017);
  tree_new->Branch("recotauh_byTightIsolationMVArun2017v1DBoldDMwLT2017",&_recotauh_byTightIsolationMVArun2017v1DBoldDMwLT2017);
  tree_new->Branch("recotauh_byVTightIsolationMVArun2017v1DBoldDMwLT2017",&_recotauh_byVTightIsolationMVArun2017v1DBoldDMwLT2017);
  tree_new->Branch("recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017",&_recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
  tree_new->Branch("recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017",&_recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
  tree_new->Branch("recotauh_byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017",&_recotauh_byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
  tree_new->Branch("recotauh_byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017",&_recotauh_byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
  tree_new->Branch("recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017",&_recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017);
  tree_new->Branch("recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017",&_recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017);
  ...
  tree_new->Branch("recotauh_fakerate_byLooseIsolationMVArun2v1DBdR03oldDMwLT",&_recotauh_fakerate_byLooseIsolationMVArun2v1DBdR03oldDMwLT);
  ...
  TMVA::Reader* mu_reader = BookLeptonMVAReader2017("lepMVA_weights", "/mu_BDTG_94X.weights.xml", "mu");
  TMVA::Reader* ele_reader = BookLeptonMVAReader2017("lepMVA_weights", "/el_BDTG_94X.weights.xml", "ele");
  ...
  //BTag SF
  bTagSF_CSVshape* bTagSF_CSVshape_computer = new bTagSF_CSVshape("bTagSF_weights/DeepCSV_94XSF_V1_B_F.csv");
  ...
  for (int i=skip_entries;i<skip_entries+nentries;i++) {
    ...
    _recotauh_byVLooseIsolationMVArun2017v2DBoldDMwLT2017.clear();
    _recotauh_byLooseIsolationMVArun2017v2DBoldDMwLT2017.clear();
    _recotauh_byMediumIsolationMVArun2017v2DBoldDMwLT2017.clear();
    _recotauh_byTightIsolationMVArun2017v2DBoldDMwLT2017.clear();
    _recotauh_byVTightIsolationMVArun2017v2DBoldDMwLT2017.clear();
    _recotauh_byVLooseIsolationMVArun2017v1DBoldDMwLT2017.clear();
    _recotauh_byLooseIsolationMVArun2017v1DBoldDMwLT2017.clear();
    _recotauh_byMediumIsolationMVArun2017v1DBoldDMwLT2017.clear();
    _recotauh_byTightIsolationMVArun2017v1DBoldDMwLT2017.clear();
    _recotauh_byVTightIsolationMVArun2017v1DBoldDMwLT2017.clear();
    _recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.clear();
    _recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.clear();
    _recotauh_byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017.clear();
    _recotauh_byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017.clear();
    _recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017.clear();
    _recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017.clear();
    ...
    _recotauh_fakerate_byLooseIsolationMVArun2v1DBdR03oldDMwLT.clear();
    ...
    _daughters_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017 = 0;
    _tauID = 0;
    _triggerbit = 0;
    _metfilterbit = 0;
    ...
    _PU_weight_ICHEP18 = getPUweight(_npu,isMC,sample);
	...
	_recomu_jetPtRel_nanoAOD.push_back( 0. );
      ...
      if (leptonMVA_ > 0.9 && mediumID) { conept = muon.Pt(); }
      else { conept = 0.90*muon.Pt()/lepMVA_jetPtRatio; }
	...
	daughter.SetPxPyPzE( (*_daughters_px_TauDown)[i_daughter] , (*_daughters_py_TauDown)[i_daughter] , (*_daughters_pz_TauDown)[i_daughter] , (*_daughters_e_TauDown)[i_daughter] );
      ...
      int byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017 = ((*_tauID)[i_daughter]>>map_tauID["byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1; 
      int byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017 = ((*_tauID)[i_daughter]>>map_tauID["byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1;
      int byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017 = ((*_tauID)[i_daughter]>>map_tauID["byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1;
      int byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017 = ((*_tauID)[i_daughter]>>map_tauID["byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1;
      int byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017 = ((*_tauID)[i_daughter]>>map_tauID["byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1;
	...
	iso_cut = byLooseIsolationMVArun2v1DBdR03oldDMwLT;
      else if(iso_type=="byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017")
        iso_cut = byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017;
      else if(iso_type=="byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017")
        iso_cut = byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017;
    ...
    for(unsigned int i_tauh=0; i_tauh<reco_taus.size(); i_tauh++){
      ...
      _recotauh_byVLooseIsolationMVArun2017v2DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVLooseIsolationMVArun2017v2DBoldDMwLT2017"])&1 );
      _recotauh_byLooseIsolationMVArun2017v2DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byLooseIsolationMVArun2017v2DBoldDMwLT2017"])&1 );
      _recotauh_byMediumIsolationMVArun2017v2DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byMediumIsolationMVArun2017v2DBoldDMwLT2017"])&1 );
      _recotauh_byTightIsolationMVArun2017v2DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byTightIsolationMVArun2017v2DBoldDMwLT2017"])&1 );
      _recotauh_byVTightIsolationMVArun2017v2DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVTightIsolationMVArun2017v2DBoldDMwLT2017"])&1 );
      _recotauh_byVLooseIsolationMVArun2017v1DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVLooseIsolationMVArun2017v1DBoldDMwLT2017"])&1 );
      _recotauh_byLooseIsolationMVArun2017v1DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byLooseIsolationMVArun2017v1DBoldDMwLT2017"])&1 );
      _recotauh_byMediumIsolationMVArun2017v1DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byMediumIsolationMVArun2017v1DBoldDMwLT2017"])&1 );
      _recotauh_byTightIsolationMVArun2017v1DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byTightIsolationMVArun2017v1DBoldDMwLT2017"])&1 );
      _recotauh_byVTightIsolationMVArun2017v1DBoldDMwLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVTightIsolationMVArun2017v1DBoldDMwLT2017"])&1 );
      
      _recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1 );
      _recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1 );
      _recotauh_byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byMediumIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1 );
      _recotauh_byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1 );
      _recotauh_byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017.push_back( ((*_tauID)[i_daughter]>>map_tauID["byVTightIsolationMVArun2017v2DBoldDMdR0p3wLT2017"])&1 );
      _recotauh_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017.push_back ( (*_daughters_byIsolationMVArun2017v2DBoldDMdR0p3wLTraw2017)[i_daughter] );
	...
	fakerate_Vtight *= f_dataMC_fakerate_tau_Vtight_endcaps->Eval(tauh.Pt());
      ...
      _recotauh_fakerate_byLooseIsolationMVArun2v1DBdR03oldDMwLT.push_back(fakerate_loose);
    ...
    for(unsigned int i_jet=0; i_jet<(*_jets_e).size(); i_jet++){
      ...
      if(jet.Pt()>25 && fabs(jet.Eta())<2.4 && PFJetID>0){  //tight PFJetID>0
    ...
    //with DeepCSV
    _bTagSF_CSVshape_weight = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::central);
    _bTagSF_CSVshape_weight_JESUp = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::JESUp);
    _bTagSF_CSVshape_weight_JESDown = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::JESDown);
    _bTagSF_CSVshape_weight_LFUp = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::LFUp);
    _bTagSF_CSVshape_weight_LFDown = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::LFDown);
    _bTagSF_CSVshape_weight_HFUp = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::HFUp);
    _bTagSF_CSVshape_weight_HFDown = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::HFDown);
    _bTagSF_CSVshape_weight_HFStats1Up = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::HFStats1Up);
    _bTagSF_CSVshape_weight_HFStats1Down = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::HFStats1Down);
    _bTagSF_CSVshape_weight_HFStats2Up = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::HFStats2Up);
    _bTagSF_CSVshape_weight_HFStats2Down = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::HFStats2Down);
    _bTagSF_CSVshape_weight_LFStats1Up = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::LFStats1Up);
    _bTagSF_CSVshape_weight_LFStats1Down = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::LFStats1Down);
    _bTagSF_CSVshape_weight_LFStats2Up = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::LFStats2Up);
    _bTagSF_CSVshape_weight_LFStats2Down = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::LFStats2Down);
    _bTagSF_CSVshape_weight_CFErr1Up = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::CFErr1Up);
    _bTagSF_CSVshape_weight_CFErr1Down = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::CFErr1Down);
    _bTagSF_CSVshape_weight_CFErr2Up = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::CFErr2Up);
    _bTagSF_CSVshape_weight_CFErr2Down = bTagSF_CSVshape_computer->getEvtWeight(_recoPFJet_DeepCSVscore, recoPFJets, _recoPFJet_hadronFlavour, bTagSF_CSVshape::CFErr2Down);
    ...
    for(unsigned int i_PFJet=0; i_PFJet<i_jet_DeepCSV_pairs.size(); i_PFJet++){
      ...
      _recoPFJet_DeepCSVsort_e.push_back( jet.E() );
      _recoPFJet_DeepCSVsort_pt.push_back( jet.Pt() );
      _recoPFJet_DeepCSVsort_px.push_back( jet.Px() );
      _recoPFJet_DeepCSVsort_py.push_back( jet.Py() );
      _recoPFJet_DeepCSVsort_pz.push_back( jet.Pz() );
      _recoPFJet_DeepCSVsort_eta.push_back( jet.Eta() );
      _recoPFJet_DeepCSVsort_phi.push_back( jet.Phi() );
      _recoPFJet_DeepCSVsort_CSVscore.push_back( (*_bCSVscore)[i_jet] );
      _recoPFJet_DeepCSVsort_DeepCSVscore.push_back( DeepCSVscore );
      _recoPFJet_DeepCSVsort_jecUnc.push_back(  (*_jets_jecUnc)[i_jet] );
      _recoPFJet_DeepCSVsort_Flavour.push_back(  (*_jets_Flavour)[i_jet] );
      _recoPFJet_DeepCSVsort_hadronFlavour.push_back(  (*_jets_HadronFlavour)[i_jet] );
      _recoPFJet_QGdiscr.push_back(  (*_jets_QGdiscr)[i_jet] );
	...
	if(i_jet==i_jet_DeepCSV_pairs[0].first || i_jet==i_jet_DeepCSV_pairs[1].first) continue;
    ...
    for(unsigned int i_tau=0; i_tau<reco_taus.size(); i_tau++){
      ...
      if (_recotauh_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017[i_tau]){ HTmiss_tlv-=tau; }
    }
