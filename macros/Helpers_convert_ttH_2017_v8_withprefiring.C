...
float get_prefire_prob(TEfficiency* pEff, float pt, float eta){

  float pref_prob;
  int globalbin = pEff->FindFixBin(pt, abs(eta));
  pref_prob = pEff->GetEfficiency(globalbin);
  return pref_prob;
...
void convert_tree(TString sample, int iso_tau=0,
  ...
  if(sample=="ttHJet_Hnonbb_ICHEP18_prefiring"){

    file="ntuple_ttH_Hnonbb_prefiring";
    dir_out="/data_CMS/cms/mperez/ttH_2017/ntuples_converted/";
 ...
 //DATA 
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleEG/DoubleEG_2017C_25Jun18/180625_204631/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/DoubleEG/DoubleEG_2017E_25Jun18/180625_204743/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/MuonEG/MuonEG_2017E_25Jun18/180625_20521/";
    ...
    dir_in="root://polgrid4.in2p3.fr//store/user/cmartinp/ttH/data2017/SingleMuon/SingleMuon_2017C_25Jun18_v3/180626_081909/";
  ...
  tree_new->Branch("jets_prefire_prob",&_jets_prefire_prob);
  ...
  tree_new->Branch("recoPFJet_prefire_prob",&_recoPFJet_prefire_prob);
  ...
  //Jet prefiring probability map
  TFile* f_prefiring_prob = TFile::Open("prefiring2017/Map_Jet_L1IsoEG30eff_bxm1_looseJet_SingleMuon_Run2017F.root");
  TEfficiency* h_prefiring_prob = (TEfficiency*)f_prefiring_prob->Get("prefireEfficiencyMap");
  ...
  for (int i=skip_entries;i<skip_entries+nentries;i++) {
    ...
    for(unsigned int i_jet=0; i_jet<(*_jets_e).size(); i_jet++){
      ...
      float jetprefprob = get_prefire_prob(h_prefiring_prob, jet.Pt(), jet.Eta());
      _jets_prefire_prob.push_back(jetprefprob);
    ...
    for(unsigned int i_PFJet=0; i_PFJet<reco_jets.size(); i_PFJet++){
      ...
      float jetprefprob = get_prefire_prob(h_prefiring_prob, jet.Pt(), jet.Eta());
      _recoPFJet_prefire_prob.push_back(jetprefprob);
