 ...
 *                                treename.push_back("HTauTauTree_2lSS_2jet_CR");*/
  ...
  treename.push_back("tree_2lSS_1tau_SR");
  treename.push_back("tree_2lSS_1tau_fakes");
  treename.push_back("tree_2lSS_1tau_flips");
  ...
  for(unsigned int i_tree=0;i_tree<treename.size();i_tree++){ //CMP for(unsigned int i_tree=0;i_tree<treename.size();i_tree++){
    ...
    std::vector<float> _recoPFJet_untag_Wtag_QGdiscr_1l2tau;
    float _CSV_b_1l2tau;
    float _qg_Wj2_1l2tau;
    float _pT_bWj1Wj2_1l2tau;
    float _m_Wj1Wj2_1l2tau;
    float _pT_Wj2_1l2tau;
    float _nllKinFit_1l2tau;
    float _pT_b_o_kinFit_pT_b_1l2tau;
    ...
    std::vector<float> _recoPFJet_untag_Wtag_QGdiscr_2lss1tau;
    float _CSV_b_2lss1tau;
    float _qg_Wj2_2lss1tau;
    float _pT_bWj1Wj2_2lss1tau;
    float _m_Wj1Wj2_2lss1tau;
    float _pT_Wj2_2lss1tau;
    float _nllKinFit_2lss1tau;
    float _pT_b_o_kinFit_pT_b_2lss1tau;
    ...
    for(int i=0;i<nentries;i++){
      ...
      _recoPFJet_untag_Wtag_QGdiscr_1l2tau.clear();
      _CSV_b_1l2tau = 0;
      _qg_Wj2_1l2tau = 0;
      _pT_bWj1Wj2_1l2tau = 0;
      _m_Wj1Wj2_1l2tau = 0;
      _pT_Wj2_1l2tau = 0;
      _nllKinFit_1l2tau = 0;
      _pT_b_o_kinFit_pT_b_1l2tau = 0;
      ...
      _recoPFJet_untag_Wtag_QGdiscr_2lss1tau.clear();
      _CSV_b_2lss1tau = 0;
      _qg_Wj2_2lss1tau = 0;
      _pT_bWj1Wj2_2lss1tau = 0;
      _m_Wj1Wj2_2lss1tau = 0;
      _pT_Wj2_2lss1tau = 0;
      _nllKinFit_2lss1tau = 0;
      _pT_b_o_kinFit_pT_b_2lss1tau = 0;
      ...
      if(_category==20 || _category==50){
        ...
        _CSV_b_1l2tau = (*_recoPFJet_btag_DeepCSVscore)[0];
            ...
            for(unsigned int i_jet1=0; i_jet1<(*_recoPFJet_untag_e).size()-1; i_jet1++){
                ...
                for(unsigned int i_jet2=i_jet1+1; i_jet2<(*_recoPFJet_untag_e).size(); i_jet2++){
                    ...
                    if( _recoPFJet_untag_best_mW<0 || (abs( mjj - mW ) < abs( _recoPFJet_untag_best_mW - mW )) ){
                        ...
                        if(jet1.Pt()>jet2.Pt()){
                             _qg_Wj2_1l2tau = (*_recoPFJet_QGdiscr)[1];
                        }
                        else{
                             _qg_Wj2_1l2tau = (*_recoPFJet_QGdiscr)[0];
                        }
                    }
                }
            }
        ...
        if (_recoPFJet_untag_Wtag_px->size()>0){
            ...
            wjet2.SetPxPyPzE((*_recoPFJet_untag_Wtag_px)[1],(*_recoPFJet_untag_Wtag_py)[1],(*_recoPFJet_untag_Wtag_pz)[1],(*_recoPFJet_untag_Wtag_e)[1]);
            mass_wjet1 = wjet1.M();
            mass_wjet2 = wjet2.M();
        ...
        _pT_bWj1Wj2_1l2tau = (bjet1+wjet1+wjet2).Pt();
        _pT_Wj2_1l2tau = wjet2.Pt();
        _m_Wj1Wj2_1l2tau = (wjet1+wjet2).M();
        _kinFit->fit(bjet1_lv,wjet1_lv,wjet2_lv);
        _nllKinFit_1l2tau = _kinFit->nll();
        _pT_b_o_kinFit_pT_b_1l2tau = (bjet1.Pt()) / (_kinFit->fittedBJet().Pt());
        ...
        CSV_b_1l2tau = _CSV_b_1l2tau; 
        qg_Wj2_1l2tau = _qg_Wj2_1l2tau;
        pT_bWj1Wj2_1l2tau = _pT_bWj1Wj2_1l2tau;
        pT_Wj2_1l2tau = _pT_Wj2_1l2tau;
        m_Wj1Wj2_1l2tau = _m_Wj1Wj2_1l2tau;
        nllKinFit_1l2tau = _nllKinFit_1l2tau;
        pT_b_o_kinFit_pT_b_1l2tau = _pT_b_o_kinFit_pT_b_1l2tau;

        float _HTT_output = MVA_HTT_reader->EvaluateMVA("BDTG method");
        _HTT_1l2tau = 1. / (1. + sqrt((1. - _HTT_output) / (1. + _HTT_output)));
        _HadTop_pt_1l2tau = (bjet1+wjet1+wjet2).Pt();
     ...
     if(_category==11 || _category==41){
        ...
        _CSV_b_2lss1tau = (*_recoPFJet_btag_DeepCSVscore)[0];
        ...
        _pT_bWj1Wj2_2lss1tau = (bjet1+wjet1+wjet2).Pt();   
        //cout<<"_pT_bWj1Wj2_2lss1tau"<<_pT_bWj1Wj2_2lss1tau<<endl;
        _pT_Wj2_2lss1tau = wjet2.Pt();
        //cout<<"_pT_Wj2_2lss1tau"<<_pT_Wj2_2lss1tau<<endl;
        _m_Wj1Wj2_2lss1tau = (wjet1+wjet2).M();
        //cout<<"_m_Wj1Wj2_2lss1tau"<<_m_Wj1Wj2_2lss1tau<<endl;
        _kinFit->fit(bjet1_lv,wjet1_lv,wjet2_lv);
        _nllKinFit_2lss1tau = _kinFit->nll();
        //cout<<"_nllKinFit_2lss1tau"<<_nllKinFit_2lss1tau<<endl;
        _pT_b_o_kinFit_pT_b_2lss1tau = (bjet1.Pt()) / (_kinFit->fittedBJet().Pt());
        //cout<<"_pT_b_o_kinFit_pT_b_2lss1tau"<<_pT_b_o_kinFit_pT_b_2lss1tau<<endl;

        avg_dr_jet_2lss1tau = _avg_dr_jet; 
        //cout<<"_avg_dr_jet"<<_avg_dr_jet<<endl;
        dr_lep1_tau_2lss1tau = _dr_lep1_tau_2lss1tau;
        //cout<<"_dr_lep1_tau_2lss1tau"<<_dr_lep1_tau_2lss1tau<<endl;
        dr_lep2_tau_2lss1tau = _dr_lep2_tau_2lss1tau;
        //cout<<"_dr_lep2_tau_2lss1tau"<<_dr_lep2_tau_2lss1tau<<endl;
        dr_leps_2lss1tau = _dr_leps_2lss1tau;
        //cout<<"_dr_leps_2lss1tau"<<_dr_leps_2lss1tau<<endl;
        lep2_conePt_2lss1tau = _lep2_conePt_2lss1tau;
        //cout<<"_lep2_conePt_2lss1tau"<<_lep2_conePt_2lss1tau<<endl;
        mT_lep1_2lss1tau = _mT_lep1_2lss1tau;
        //cout<<"_mT_lep1_2lss1tau"<<_mT_lep1_2lss1tau<<endl;
        mT_lep2_2lss1tau = _mT_lep2_2lss1tau;
        //cout<<"_mT_lep2_2lss1tau"<<_mT_lep2_2lss1tau<<endl;
        mTauTauVis2_2lss1tau = _mTauTauVis2_2lss1tau;
        //cout<<"_mTauTauVis2_2lss1tau"<<_mTauTauVis2_2lss1tau<<endl;
        max_lep_eta_2lss1tau = _max_lep_eta_2lss1tau;
        //cout<<"_max_lep_eta_2lss1tau"<<_max_lep_eta_2lss1tau<<endl;
        mbb_2lss1tau = _mbb_2lss1tau;
        //cout<<"_mbb_2lss1tau"<<_mbb_2lss1tau<<endl;
        mindr_lep1_jet_2lss1tau = _mindr_lep1_jet_2lss1tau;
        //cout<<"_mindr_lep1_jet_2lss1tau"<<_mindr_lep1_jet_2lss1tau<<endl;
        mindr_lep2_jet_2lss1tau = _mindr_lep2_jet_2lss1tau;
        //cout<<"_mindr_lep2_jet_2lss1tau"<<_mindr_lep2_jet_2lss1tau<<endl;
        mindr_tau_jet_2lss1tau = _mindr_tau_jet_2lss1tau;
        //cout<<"_mindr_tau_jet_2lss1tau"<<_mindr_tau_jet_2lss1tau<<endl;
        nJet_2lss1tau = _nJet_2lss1tau;
        //cout<<"_nJet_2lss1tau"<<_nJet_2lss1tau<<endl;
        ptmiss_2lss1tau = _ptmiss_2lss1tau;
        //cout<<"_ptmiss_2lss1tau"<<_ptmiss_2lss1tau<<endl;
        tau_pt_2lss1tau = _tau_pt_2lss1tau;
        //cout<<"_tau_pt_2lss1tau"<<_tau_pt_2lss1tau<<endl;
      
        CSV_b_2lss1tau = _CSV_b_2lss1tau;
        //cout<<"_CSV_b_2lss1tau"<<_CSV_b_2lss1tau<<endl;
        qg_Wj2_2lss1tau = _qg_Wj2_2lss1tau;
        //cout<<"_qg_Wj2_2lss1tau"<<_qg_Wj2_2lss1tau<<endl;
        pT_bWj1Wj2_2lss1tau = _pT_bWj1Wj2_2lss1tau;
        //cout<<"_pT_bWj1Wj2_2lss1tau"<<_pT_bWj1Wj2_2lss1tau<<endl;
        pT_Wj2_2lss1tau = _pT_Wj2_2lss1tau;
        //cout<<"_pT_Wj2_2lss1tau"<<_pT_Wj2_2lss1tau<<endl;
        m_Wj1Wj2_2lss1tau = _m_Wj1Wj2_2lss1tau;
        //cout<<"_m_Wj1Wj2_2lss1tau"<<_m_Wj1Wj2_2lss1tau<<endl;
        nllKinFit_2lss1tau = _nllKinFit_2lss1tau;
        //cout<<"_nllKinFit_2lss1tau"<<_nllKinFit_2lss1tau<<endl;
        pT_b_o_kinFit_pT_b_2lss1tau = _pT_b_o_kinFit_pT_b_2lss1tau;
        //cout<<" _pT_b_o_kinFit_pT_b_2lss1tau"<< _pT_b_o_kinFit_pT_b_2lss1tau<<endl;

        float _HTT_output = MVA_HTT_reader->EvaluateMVA("BDTG method");
        _HTT_2lss1tau = 1. / (1. + sqrt((1. - _HTT_output) / (1. + _HTT_output)));   
        _HadTop_pt_2lss1tau = (bjet1+wjet1+wjet2).Pt();
        ...
        //cout<<"HTT_2lss1tau "<<_HTT_2lss1tau;
     ...
     if(_category==16 || _category==46){
        ...
        _mindr_tau_jet_3l1tau = _mindR_jettau;
        ...
        //cout<<_mTauTauVis1<<" "<<_mTauTauVis2<<" "<<_max_lep_eta<<" "<<_ptmiss<<" "<<_tau_pt<<" "<<_dr_leps<<" "<<_mindr_lep1_jet<<" "<<_mindr_tau_jet<<" "<<_mbb_loose<<" "<<_lep1_conePt<<" "<<_lep2_conePt<<" "<<_nJet<<endl;
