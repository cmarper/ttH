...
void convert_tree(TString sample, int iso_tau=0,
		  TString iso_type="byVLooseIsolationMVArun2v2017v2DBoldDMdR0p3wLT", bool conept_sorting=true,
  ...
  if(sample=="test"){
    ...
    file="ntuple_LLR_converted_ttHNonbb_Autumn18_24Jan18";
    dir_out="/data_CMS/cms/mperez/ttH_Legacy/2018/ntuples_sync/";
    ...
    list.push_back("/data_CMS/cms/mperez/ttH_Legacy/2018/ntuples_sync/ntuple_LLR_sync_ttHNonbb_Autumn18_24Jan18.root");
