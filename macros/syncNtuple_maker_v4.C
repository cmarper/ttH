...
void create_syncNtuple(){
  ...
  TString dir_in="/data_CMS/cms/mperez/ttH_2017_sync/ntuples_converted/nominal/ttH/";
  TString dir_out="/data_CMS/cms/mperez/ttH_2017_sync/syncNtuples/";

  //TString file="syncNtuple_ttW_multilep.root";
  TString file="syncNtuple_ttH_v24_newfmw.root";


  vector<TString> list;
  //list.push_back(dir_in+"syncNtuple_ttW_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");
  list.push_back(dir_in+"syncNtuple_94X_v24_newfmw_0_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root");
