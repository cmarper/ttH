  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TH1F* h_MC_genmatch = single_plot(filename_MC[i_MC],
					"HTauTauTree_2lSS",
					var,
					MC_weight + Form("*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*event_weight_ttH*tauSF_weight*(category==%i && recotauh_sel_byLooseIsolationMVArun2v2DBdR03oldDMwLT2017[0] && recolep_sel_isGenMatched[0] && recolep_sel_isGenMatched[1] && ",cat_fakes[i_cat]) + MC_sample_cut[i_MC] + " && " + cut_cat + ")",
				    nbin,xmin,xmax);
    ...
    TH1F* h_fakes =single_plot(filename_data,
			       "HTauTauTree_2lSS",
			       var,			     
			       Form("event_weight_ttH*(category==%i && recotauh_sel_byLooseIsolationMVArun2v2DBdR03oldDMwLT2017[0] &&",cat_fakes[i_cat]) + cut_cat + ")",
			       nbin,xmin,xmax);
    ...
    TH1F* h_ttbar_DL_fakes_MC =single_plot(filename_ttbar_DL,
				  "HTauTauTree_2lSS",
				  var,
				  Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*bTagSF_CSVshape_weight*leptonSF_ttH_weight*tauSF_weight*event_weight_ttH*(category==%i && recotauh_sel_byLooseIsolationMVArun2v2DBdR03oldDMwLT2017[0] && ",cat_fakes[i_cat]) + cut_cat + ")",
				  nbin,xmin,xmax);
    ...
    TH1F* h_flips =single_plot(filename_data,
			       "HTauTauTree_2lSS",
			       var,
			       Form("event_weight_ttH*(category==%i &&",cat_flips[i_cat]) + cut_cat_flips + ")",			      
			       nbin,xmin,xmax);
    
    h_flips->Scale(luminosity/41298.); //Data files for 35.9 fb-1
	...
	syst_name+="ttW1";
      ...
      TString cut = "PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*tauSF_weight*bTagSF_CSVshape_weight";
...
TString h_name_ttH = "x_ttH"+bkg_type[i_bkg]+"_CMS_ttHl16_FRjt_";
   ...
   cout<<"OK syst tau fakes"<<endl;
    ...
    TH1F* h_TT_DL_clos_ele_diff = single_plot(filename_ttbar_DL,
					      "HTauTauTree_2lSS",
					      var,
					      Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*tauSF_weight*bTagSF_CSVshape_weight*(event_weight_ttH_ele_FR_TT_MC_v2-event_weight_ttH_ele_FR_QCD_MC_v2)*(category==%i && recotauh_sel_byLooseIsolationMVArun2v2DBdR03oldDMwLT2017[0] && ",cat_fakes[i_cat]) + cut_cat + ")",
					    nbin,xmin,xmax);
...
void datacard_maker_mvis_2lSS1tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_mvis_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_n_fakelep_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_n_fakelep_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_n_fakeele_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_n_fakeele_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_n_fakemu_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_n_fakemu_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_n_faketau_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_n_faketau_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_n_jet_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_n_jet_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_n_jet_CSVloose_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_n_jet_CSVloose_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_n_jet_CSVmedium_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_n_jet_CSVmedium_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_ETmiss_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_ETmiss_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_lep_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_lep_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_mu_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_mu_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_ele_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_ele_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_tau1_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_tau1_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_tau2_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_tau2_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_DM_tau1_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_DM_tau1_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_DM_tau2_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_DM_tau2_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_jet1_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_jet1_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_jet2_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_jet2_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_bjet1_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_bjet1_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_pT_bjet2_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_pT_bjet2_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_CSV_jet1_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_DeepCSV_jet1_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_CSV_jet2_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_DeepCSV_jet2_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_mltau_2lSS1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_mltau_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_nvtx_2lSS1tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2lSS1tau/datacard_nvtx_2lSS1tau_syst_28Jun18.root";
...
void datacard_maker_all(){
  ...
  //datacard_maker_BDT_2lSS1tau_syst();
  ...
  datacard_maker_pT_tau2_2lSS1tau();
