...
int add_BDT_3l1tau(string input, string output, vector<string> treename){

  cout<<"Computing 3l1tau BDT..."<<endl;
  ...
  for(unsigned int i_tree=0;i_tree<treename.size();i_tree++){
    ...
    */
    ...
    //new variables
      ...
      _mTauTauVis2 = (OS2) ? (tau1+lep2).M() : -1.;      
      ...
      mTauTauVis1_3l1tau = _mTauTauVis1;
      mTauTauVis2_3l1tau = _mTauTauVis2;
      max_lep_eta_3l1tau = _max_lep_eta;
      ptmiss_3l1tau = _ptmiss;
      tau_pt_3l1tau = _tau_pt;
      dr_leps_3l1tau = _dr_leps;
      mindr_lep1_jet_3l1tau = _mindr_lep1_jet;
      mindr_tau_jet_3l1tau = _mindr_tau_jet; 
      mbb_loose_3l1tau = _mbb_loose;
      lep1_conePt_3l1tau = _lep1_conePt;
      lep2_conePt_3l1tau = _lep2_conePt;
      nJet_3l1tau = _nJet;
