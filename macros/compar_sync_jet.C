...
void compar(TString institute = "ND"){
  ...
  TString log_file;
  if (institute == "ND") { log_file = "../sync/log_ND_jet.txt";}
  if (institute == "IHEP") { log_file = "../sync/log_IHEP_jet.txt";}
...
void compar_EventNumber_jet(TString institute = "ND"){
  ...
  tree->Draw("EventNumber>>h","n_recoPFJet>=1","goff");

  TH1F* h_sync; 
  if (institute == "ND") {h_sync = histo_fromlog("../sync/log_ND_jet.txt",0,500000,0,500000);}
  if (institute == "IHEP") {h_sync = histo_fromlog("../sync/log_IHEP_jet.txt",0,500000,0,500000);}
  ...
  TString plotname;
  if (institute == "ND") {plotname="sync/EventNumber_jet_LLR_ND";}
  if (institute == "IHEP") {plotname="sync/EventNumber_jet_LLR_IHEP";}
...
void compar_pt_jet(TString institute = "ND"){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/data_CMS/cms/mperez/ttH_test_2016/ntuples_converted/nominal/ttH/syncNtuple_ttH_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");

  TH1F* h = new TH1F("h","h",200,0,1000);
  tree->Draw("recoPFJet_pt[0]>>h","n_recoPFJet>=1","goff");

  TH1F* h_sync; 
  if (institute == "ND") {h_sync = histo_fromlog("../sync/log_ND_jet.txt",1,200,0,1000);}
  if (institute == "IHEP") {h_sync = histo_fromlog("../sync/log_IHEP_jet.txt",1,200,0,1000);}
  ...
  TString plotname;
  if (institute == "ND") {plotname="sync/pt_jet_LLR_ND";}
  if (institute == "IHEP") {plotname="sync/pt_jet_LLR_IHEP";}
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_eta_jet(TString institute = "ND"){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/data_CMS/cms/mperez/ttH_test_2016/ntuples_converted/nominal/ttH/syncNtuple_ttH_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");
 
  TH1F* h = new TH1F("h","h",75,-3,3);
  tree->Draw("recoPFJet_eta[0]>>h","n_recoPFJet>=1","goff");

  TH1F* h_sync;  
  if (institute == "ND") {h_sync = histo_fromlog("../sync/log_ND_jet.txt",2,75,-3,3);}
  if (institute == "IHEP") {h_sync = histo_fromlog("../sync/log_IHEP_jet.txt",2,75,-3,3);}
  ...
  TString plotname;
  if (institute == "ND") {plotname="sync/eta_jet_LLR_ND";}
  if (institute == "IHEP") {plotname="sync/eta_jet_LLR_IHEP";}
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_phi_jet(TString institute = "ND"){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/data_CMS/cms/mperez/ttH_test_2016/ntuples_converted/nominal/ttH/syncNtuple_ttH_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");

  TH1F* h = new TH1F("h","h",80,-3.2,3.2);
  tree->Draw("recoPFJet_phi[0]>>h","n_recoPFJet>=1","goff");

  TH1F* h_sync;  
  if (institute == "ND") {h_sync = histo_fromlog("../sync/log_ND_jet.txt",3,80,-3.2,3.2);}
  if (institute == "IHEP") {h_sync = histo_fromlog("../sync/log_IHEP_jet.txt",3,80,-3.2,3.2);}
  ...
  TString plotname;
  if (institute == "ND") {plotname="sync/phi_jet_LLR_ND";}
  if (institute == "IHEP") {plotname="sync/phi_jet_LLR_IHEP";}
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_E_jet(TString institute = "ND"){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/data_CMS/cms/mperez/ttH_test_2016/ntuples_converted/nominal/ttH/syncNtuple_ttH_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");
 
  TH1F* h = new TH1F("h","h",200,0,1000);
  tree->Draw("recoPFJet_e[0]>>h","n_recoPFJet>=1","goff");

  TH1F* h_sync;  
  if (institute == "ND") {h_sync = histo_fromlog("../sync/log_ND_jet.txt",4,200,0,1000);}
  if (institute == "IHEP") {h_sync = histo_fromlog("../sync/log_IHEP_jet.txt",4,200,0,1000);}
  ...
  TString plotname;
  if (institute == "ND") {plotname="sync/E_jet_LLR_ND";}
  if (institute == "IHEP") {plotname="sync/E_jet_LLR_IHEP";}
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_CSV_jet(TString institute = "ND"){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/data_CMS/cms/mperez/ttH_test_2016/ntuples_converted/nominal/ttH/syncNtuple_ttH_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");

  TH1F* h = new TH1F("h","h",100,0,1);
  tree->Draw("recoPFJet_CSVscore[0]>>h","n_recoPFJet>=1","goff");

  TH1F* h_sync;  
  if (institute == "ND") {h_sync = histo_fromlog("../sync/log_ND_jet.txt",5,100,0,1);}
  if (institute == "IHEP") {h_sync = histo_fromlog("../sync/log_IHEP_jet.txt",5,100,0,1);}
  ...
  TString plotname;
  if (institute == "ND") {plotname="sync/CSV_jet_LLR_ND";}
  if (institute == "IHEP") {plotname="sync/CSV_jet_LLR_IHEP";}
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_MET(TString institute = "ND"){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/data_CMS/cms/mperez/ttH_test_2016/ntuples_converted/nominal/ttH/syncNtuple_ttH_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");

  TH1F* h = new TH1F("h","h",100,0,500);
  tree->Draw("met>>h","n_recoPFJet>=1","goff");

  TH1F* h_sync;  
  if (institute == "ND") {h_sync = histo_fromlog("../sync/log_ND_jet.txt",6,100,0,500);}
  if (institute == "IHEP") {h_sync = histo_fromlog("../sync/log_IHEP_jet.txt",6,100,0,500);}
  ...
  TString plotname;
  if (institute == "ND") {plotname="sync/MET_LLR_ND";}
  if (institute == "IHEP") {plotname="sync/MET_LLR_IHEP";}
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
...
void compar_MET_phi(TString institute = "ND"){

  TChain * tree = new TChain("HTauTauTree");
  tree->Add("/data_CMS/cms/mperez/ttH_test_2016/ntuples_converted/nominal/ttH/syncNtuple_ttH_multilep_0_byLooseIsolationMVArun2v1DBdR03oldDMwLT.root");

  TH1F* h = new TH1F("h","h",100,-3.2,3.2);
  tree->Draw("metphi>>h","n_recoPFJet>=1","goff");

  TH1F* h_sync;  
  if (institute == "ND") {h_sync = histo_fromlog("../sync/log_ND_jet.txt",7,100,-3.2,3.2);}
  if (institute == "IHEP") {h_sync = histo_fromlog("../sync/log_IHEP_jet.txt",7,100,-3.2,3.2);}
  ...
  TString plotname;
  if (institute == "ND") {plotname="sync/phi_MET_LLR_ND";}
  if (institute == "IHEP") {plotname="sync/phi_MET_LLR_IHEP";}
  c->SaveAs("../plots/pdf/"+plotname+".pdf");
  c->SaveAs("../plots/png/"+plotname+".png");
