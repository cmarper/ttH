  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TH1F* h_MC = single_plot(filename_MC[i_MC],
			       "HTauTauTree_3l",
			       var,
			       Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*tauSF_weight*(category==%i &&",cat[i_cat]) + MC_sample_cut[i_MC] + " && " + cut_cat + ")",
			       nbin,xmin,xmax);
    ...
    TH1F* h_fakes =single_plot(filename_data,
			       "HTauTauTree_3l_lepMVA_CR",
			       var,
			       Form("event_weight_ttH*(category==%i && recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017[0] && NBadMu==0 &&",cat_fakes[i_cat]) + cut_cat + ")",
			       nbin,xmin,xmax);
    ...
    TH1F* h_data_obs =single_plot(filename_data,
				  "HTauTauTree_3l",
				  var,
				  Form("(category==%i && NBadMu==0 &&",cat[i_cat]) + cut_cat + ")",		
				  nbin,xmin,xmax);
	...
	TString cut = "MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*tauSF_weight*bTagSF_CSVshape_weight_" + bTag_syst_names[i_b]+"_v2";
	...
	TString cut = "MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*tauSF_weight_"+ jetToTau_FR_syst_names[i_t] +"_v2";
	cut+=Form("*(category==%i  &&",cat[i_cat]) + MC_sample_cut[i_MC] + " && " + cut_cat +")";
    ...
    /*TH1F* h_TT_DL_clos_ele_diff = single_plot(filename_ttbar_DL,
					    "HTauTauTree_3l_lepMVA_CR",
					    var,
					    Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*bTagSF_CSVshape_weight*leptonSF_ttH_weight*tauSF_weight*(event_weight_ttH_ele_FR_TT_MC-event_weight_ttH_ele_FR_QCD_MC)*(category==%i && recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017[0] && ",cat_fakes[i_cat]) + cut_cat + ")",
					    nbin,xmin,xmax);
    
    h_TT_DL_clos_ele_diff->Scale(luminosity*XS_ttbar_DL/h_ttbar_DL_norm->Integral());

    TH1F* h_TT_SLfromT_clos_ele_diff = single_plot(filename_ttbar_SL,
                                            "HTauTauTree_3l_lepMVA_CR",
                                            var,
                                            Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*bTagSF_CSVshape_weight*leptonSF_ttH_weight*tauSF_weight*(event_weight_ttH_ele_FR_TT_MC-event_weight_ttH_ele_FR_QCD_MC)*(category==%i && recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017[0] && ",cat_fakes[i_cat]) + cut_cat + ")",
                                            nbin,xmin,xmax);

    h_TT_SLfromT_clos_ele_diff->Scale(luminosity*XS_ttbar_SL/h_ttbar_SL_norm->Integral());

    TH1F* h_TT_SLfromTbar_clos_ele_diff = single_plot(filename_ttbar_SL,
                                            "HTauTauTree_3l_lepMVA_CR",
                                            var,
                                            Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*bTagSF_CSVshape_weight*leptonSF_ttH_weight*tauSF_weight*(event_weight_ttH_ele_FR_TT_MC-event_weight_ttH_ele_FR_QCD_MC)*(category==%i && recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017[0] && ",cat_fakes[i_cat]) + cut_cat + ")",
                                            nbin,xmin,xmax);

    h_TT_SLfromTbar_clos_ele_diff->Scale(luminosity*XS_ttbar_SL/h_ttbar_SL_norm->Integral());
   ...
   TH1F* h_TT_SLfromT_clos_mu_diff = single_plot(filename_ttbar_SL,
                                            "HTauTauTree_3l_lepMVA_CR",
                                            var,
                                            Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*bTagSF_CSVshape_weight*leptonSF_ttH_weight*tauSF_weight*(event_weight_ttH_mu_FR_TT_MC_v2-event_weight_ttH_mu_FR_QCD_MC_v2)*(category==%i && recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017[0] && ",cat_fakes[i_cat]) + cut_cat + ")",                                   
                                            nbin,xmin,xmax);

    h_TT_SLfromT_clos_mu_diff->Scale(luminosity*XS_ttbar_SL/h_ttbar_SL_norm->Integral());

   TH1F* h_TT_SLfromTbar_clos_mu_diff = single_plot(filename_ttbar_SL,
                                            "HTauTauTree_3l_lepMVA_CR",
                                            var,
                                            Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*bTagSF_CSVshape_weight*leptonSF_ttH_weight*tauSF_weight*(event_weight_ttH_mu_FR_TT_MC_v2-event_weight_ttH_mu_FR_QCD_MC_v2)*(category==%i && recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017[0] && ",cat_fakes[i_cat]) + cut_cat + ")",
                                            nbin,xmin,xmax);

    h_TT_SLfromTbar_clos_mu_diff->Scale(luminosity*XS_ttbar_SL/h_ttbar_SL_norm->Integral());
    ...
    */
    ...
    /*for(unsigned int i_f=0;i_f<fake_syst_names.size();i_f++){
        ...
        TString cut = "event_weight_ttH_"+fake_syst_names[i_f]+Form("_v2*(category==%i  && recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017[0] && ",cat_fakes[i_cat]) + cut_cat + ")";
...
/*void datacard_maker_MVA_3l_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_MVA_3l_syst_nofaketau_180622.root";
...
void datacard_maker_n_fakelep_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_n_fakelep_3l1tau_syst_180622.root";
...
void datacard_maker_n_fakeele_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_n_fakeele_3l1tau_syst_180622.root";
...
void datacard_maker_n_fakemu_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_n_fakemu_3l1tau_syst_180622.root";
...
void datacard_maker_n_faketau_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_n_faketau_3l1tau_syst_180622.root";
...
void datacard_maker_n_jet_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_n_jet_3l1tau_syst_180622.root";
...
void datacard_maker_n_jet_DeepCSVloose_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_n_jet_DeepCSVloose_3l1tau_syst_180622.root";
...
void datacard_maker_n_jet_DeepCSVmedium_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_n_jet_DeepCSVmedium_3l1tau_syst_180622.root";
...
void datacard_maker_ETmiss_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_ETmiss_3l1tau_syst_180622.root";
...
void datacard_maker_pT_lep1_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_pT_lep1_3l1tau_syst_180622.root";
...
void datacard_maker_pT_lep2_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_pT_lep2_3l1tau_syst_180622.root";
...
void datacard_maker_pT_lep3_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_pT_lep3_3l1tau_syst_180622.root";
...
void datacard_maker_pT_tau_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_pT_tau_3l1tau_syst_180622.root";
...
void datacard_maker_DM_tau_3l1tau(){
 ...
 TString var="recotauh_sel_decayMode[0]*(recotauh_sel_decayMode[0]<2) + 2*(recotauh_sel_decayMode[0]>=2)";
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_DM_tau_3l1tau_syst_180622.root";
...
void datacard_maker_pT_jet1_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_pT_jet1_3l1tau_syst_180622.root";
...
void datacard_maker_pT_jet2_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_pT_jet2_3l1tau_syst_180622.root";
...
void datacard_maker_pT_bjet1_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_pT_bjet1_3l1tau_syst_180622.root";
...
void datacard_maker_pT_bjet2_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_pT_bjet2_3l1tau_syst_180622.root";
...
void datacard_maker_DeepCSV_jet1_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_DeepCSV_jet1_3l1tau_syst_180622.root";
...
void datacard_maker_DeepCSV_jet2_3l1tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_DeepCSV_jet2_3l1tau_syst_180622.root";
...
void datacard_maker_MVA_3l_ttbar(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_MVA_3l_ttbar_nofaketau_180622.root";
...
/*void datacard_maker_MVA_3l_ttV(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/3l1tau/datacard_MVA_3l_ttV_nofaketau_180622.root";
...
void datacard_maker_all(){
  ...
  datacard_maker_n_jet_DeepCSVloose_3l1tau();
  datacard_maker_n_jet_DeepCSVmedium_3l1tau();
  ...
  datacard_maker_DeepCSV_jet1_3l1tau();
  datacard_maker_DeepCSV_jet2_3l1tau();
