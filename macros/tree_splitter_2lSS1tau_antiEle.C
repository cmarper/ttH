...
void split_tree_2lSS1tau(TString filename_in, TString filename_out, TString antiEleWP,
  ...
  tree_2lSS_1tau_SR->SetNameTitle("tree_2lSS_1tau_SR","tree_2lSS_1tau_SR");

  TTree* tree_2lSS_1tau_fakes=tree->GetTree()->CloneTree(0);
  tree_2lSS_1tau_fakes->SetNameTitle("tree_2lSS_1tau_fakes","tree_2lSS_1tau_fakes");

  TTree* tree_2lSS_1tau_flips=tree->GetTree()->CloneTree(0);
  tree_2lSS_1tau_flips->SetNameTitle("tree_2lSS_1tau_flips","tree_2lSS_1tau_flips");

  vector<TTree*> tree_new;

  tree_new.push_back(tree_2lSS_1tau_SR);
  tree_new.push_back(tree_2lSS_1tau_fakes);
  tree_new.push_back(tree_2lSS_1tau_flips);
  ...
  */
  ...
  int n_sig_2lSS1tau_base = 0;
  int n_sig_2lSS1tau_SR = 0;
  int n_sig_2lSS1tau_fakes = 0;
  int n_sig_2lSS1tau_flips = 0;
  ...
  for (int i=skip_entries;i<skip_entries+nentries;i++) {
    ...
    if(_n_recolep_fakeable>=2 && _n_recotauh>0 && _n_recolep_mvasel<=2){
      ...
      //cout<<"loose mu "<<(*_recomu_e).size()<<endl;
      ...
      //cout<<"loose ele "<<(*_recoele_e).size()<<endl;

      float m_ll = 0;
      //loop over loose leptons for invariant mass
      ...
      /*if (_EventNumber==17842164){
        cout<<"m_ll "<<m_ll<<endl;
      }*/
      /*cout<<"loose lep "<<loose_leptons.size()<<endl;
      cout<<"inv_mass_Zee "<<inv_mass_Zee<<endl;
      cout<<"inv_mass_lep_pairs "<<inv_mass_lep_pairs<<endl;*/
	
      //loop over leptons to store selected ones
      ...
      //cout<<"selected lep "<<_recolep_sel_e.size()<<endl;
	
      int n_tau_Med = 0;	
      bool tightleadingtau = 0;  
	
      //loop over tau_h to store selected ones
      for(unsigned int i_tau=0; i_tau<(*_recotauh_charge).size(); i_tau++){

        if((*_recotauh_byLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017)[0]>0.5) tightleadingtau = true;
      ...
      //cout<<"selected taus "<<_recotauh_sel_e.size()<<endl;
      ...
      else if (antiEleWP=="VLoose") antiEle = _recotauh_sel_againstElectronVLooseMVA6[0];
      else if (antiEleWP=="Loose") antiEle = _recotauh_sel_againstElectronLooseMVA6[0];
      else if (antiEleWP=="Medium") antiEle = _recotauh_sel_againstElectronMediumMVA6[0];
      ...
      if (sig_2lSS1tau_fakes) {
          n_sig_2lSS1tau_fakes += 1;
          tree_2lSS_1tau_fakes->Fill();
      }

      if (sig_2lSS1tau_flips) {
          n_sig_2lSS1tau_flips += 1;
          tree_2lSS_1tau_flips->Fill();
      }
    }
  }
  ...
  cout<<"sig "<<n_sig_2lSS1tau_SR<<endl;
  cout<<"fakes "<<n_sig_2lSS1tau_fakes<<endl;
  cout<<"flips "<<n_sig_2lSS1tau_flips<<endl;
...
void split_all(){
  ...
  /*split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_0_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_0_split.root",
    0, 0, true, true);

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_0_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_0_split_VLoose.root",
    0, 0, true, true, "VLoose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_0_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_0_split_Loose.root",
    0, 0, true, true, "Loose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_0_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_0_split_Medium.root",
    0, 0, true, true, "Medium");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_0_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_0_split_Tight.root",
    0, 0, true, true, "Tight");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_0_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_0_split_VTight.root",
    0, 0, true, true, "VTight");*/

  /*split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_1_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_1_split.root",
    0, 0, true, true);

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_1_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_1_split_VLoose.root",
    0, 0, true, true, "VLoose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_1_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_1_split_Loose.root",
    0, 0, true, true, "Loose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_1_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_1_split_Medium.root",
    0, 0, true, true, "Medium");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_1_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_1_split_Tight.root",
    0, 0, true, true, "Tight");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_1_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_1_split_VTight.root",
    0, 0, true, true, "VTight");

    split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_2_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_2_split.root",
    0, 0, true, true);

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_2_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_2_split_VLoose.root",
    0, 0, true, true, "VLoose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_2_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_2_split_Loose.root",
    0, 0, true, true, "Loose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_2_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_2_split_Medium.root",
    0, 0, true, true, "Medium");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_2_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_2_split_Tight.root",
    0, 0, true, true, "Tight");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_2_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_2_split_VTight.root",
    0, 0, true, true, "VTight");

    split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_3_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_3_split.root",
    0, 0, true, true);

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_3_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_3_split_VLoose.root",
    0, 0, true, true, "VLoose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_3_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_3_split_Loose.root",
    0, 0, true, true, "Loose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_3_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_3_split_Medium.root",
    0, 0, true, true, "Medium");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_3_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_3_split_Tight.root",
    0, 0, true, true, "Tight");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_3_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_3_split_VTight.root",
    0, 0, true, true, "VTight");

    split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_4_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_4_split.root",
    0, 0, true, true);

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_4_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_4_split_VLoose.root",
    0, 0, true, true, "VLoose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_4_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_4_split_Loose.root",
    0, 0, true, true, "Loose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_4_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_4_split_Medium.root",
    0, 0, true, true, "Medium");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_4_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_4_split_Tight.root",
    0, 0, true, true, "Tight");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_4_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_4_split_VTight.root",
    0, 0, true, true, "VTight");

    split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_5_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_5_split.root",
    0, 0, true, true);

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_5_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_5_split_VLoose.root",
    0, 0, true, true, "VLoose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_5_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_5_split_Loose.root",
    0, 0, true, true, "Loose");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_5_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_5_split_Medium.root",
    0, 0, true, true, "Medium");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_5_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_5_split_Tight.root",
    0, 0, true, true, "Tight");

  split_tree_2lSS1tau("/data_CMS/cms/mperez/ttH_2017/ntuples_converted/nominal/ttH/ntuple_ttH_Hnonbb_5_byVLooseIsolationMVArun2017v2DBoldDMdR0p3wLT2017.root", 
    "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/ttH/antiEle/HTauTauTree_ttH_Hnonbb_5_split_VTight.root",
    0, 0, true, true, "VTight");
