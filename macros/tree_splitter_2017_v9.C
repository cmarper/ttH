...
void split_tree(TString filename_in, TString filename_out,
  ...
  tree_3l_1tau_SR->SetNameTitle("HTauTauTree_3l_1tau_SR","HTauTauTree_3l_1tau_SR");
  ...
  tree_ttZctrl_fake->SetNameTitle("HTauTauTree_ttZctrl_fake","HTauTauTree_ttZctrl_fake");
