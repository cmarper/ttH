...
void compareSyncNtuples()
{
  ...
  std::string inputFilePath_ref = "/data_CMS/cms/mperez/ttH_2017/syncNtuples";
  std::string inputFileName_ref = "syncNtuple_ttH_v20.root";
  ...
  std::string legendEntry_ref = "LLR, v20";
  std::string selection_ref = "n_presel_jet >= 1";

  std::string inputFilePath_test = "/data_CMS/cms/mperez/ttH_2017/syncNtuples";
  //std::string inputFileName_test = "syncNtuple_object_cornell_v7.root"; std::string legendEntry_test = "Cornell, v7";
  //std::string inputFileName_test = "sync_Tallinn_v19.root"; std::string legendEntry_test = "Tallinn, v19";
  std::string inputFileName_test = "IHEP_ttHsyncV6.root"; std::string legendEntry_test = "IHEP, v6";
  ...
  //std::string outputFilePath = "../plots_syncNtuple_94X_LLR20_Cor7";
  //std::string outputFilePath = "../plots_syncNtuple_94X_LLR20_Tal19";
  std::string outputFilePath = "../plots_syncNtuple_94X_LLR20_IHEP6";
