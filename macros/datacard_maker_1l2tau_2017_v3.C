...
#include "Helpers.C"
 ...
 float XS_ttbar_SL = 365.34; //SL semileptonic
 ...
 //FIXME TString filename_tZq = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/Rares/HTauTauTree_tZq_split_withPU.root";
 TString filename_TTTT = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/Rares/HTauTauTree_TTTT_split_withPU.root";

 //FIXME TString filename_WpWp = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/nominal/Rares/HTauTauTree_WpWp_split_withPU.root";
 ...
 TString filename_ttZ_JECup = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECup/ttV/HTauTauTree_ttZ_split_withPU_JECup.root";
 TString filename_ttZ_JECdown = "/data_CMS/cms/mperez/ttH_2017/ntuples_splitted/JECdown/ttV/HTauTauTree_ttZ_split_withPU_JECdown.root";
  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TH1F* h_MC_genmatch = single_plot(filename_MC[i_MC],
					...
					var,
					Form("MC_weight*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight* bTagSF_CSVshape_weight*tauSF_weight*event_weight_ttH*(category==%i && isGenMatched &&",cat_fakes[i_cat]) + MC_sample_cut[i_MC] + " && " + cut_cat + ")",
					nbin,x);
    ...
    TH1F* h_fakes =single_plot(filename_data,
			       "HTauTauTree_1l_2tau_fake_CR",
			       var,
			       Form("event_weight_ttH*(category==%i && NBadMu==0 &&",cat_fakes[i_cat]) + cut_cat + ")",
			       nbin,x);
    ...
    TH1F* h_fakes_unweighed =single_plot(filename_data,
					 "HTauTauTree_1l_2tau_fake_CR",
					 var,
					 Form("(category==%i && NBadMu==0 &&",cat_fakes[i_cat]) + cut_cat + ")",
					 nbin,x);
    ...
    for(unsigned int i_t=0;i_t<jetToTau_FR_syst_names.size();i_t++){       
      ...
      TString cut = weight + Form("*(category==%i && NBadMu==0 &&",cat_fakes[i_cat]) + cut_cat +")";
...
void datacard_maker_mvis_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_mvis_1l2tau_syst_180621.root";
...
void datacard_maker_BDT_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_BDT_1l2tau_syst_180621.root";
...
void datacard_maker_BDT_1l2tau_syst_mergelast(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_BDT_1l2tau_syst_180621_mergelast.root";
...
void datacard_maker_BDT_1l2tau_syst_altlast(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_BDT_1l2tau_syst_180621_altlast.root";
...
void datacard_maker_BDT_1l2tau_syst_40bins(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_BDT_1l2tau_syst_180621_40bins.root";
...
void datacard_maker_BDT_1l2tau_syst_100bins(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_BDT_1l2tau_syst_180621_100bins.root";
...
void datacard_maker_transfBDT_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_transfBDT_1l2tau_syst_180621.root";
...
void datacard_maker_BDT_1l2tau_syst_highpTlep(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_BDT_1l2tau_syst_highpTlep_180621.root";
...
void datacard_maker_n_fakelep_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_fakelep_1l2tau_syst_180621.root";
...
void datacard_maker_n_fakeele_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_fakeele_1l2tau_syst_180621.root";
...
void datacard_maker_n_fakemu_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_fakemu_1l2tau_syst_180621.root";
...
void datacard_maker_n_faketau_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_faketau_1l2tau_syst_180621.root";
...
void datacard_maker_n_jet_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_jet_1l2tau_syst_180621.root";
...
void datacard_maker_n_jet_CSVloose_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_jet_CSVloose_1l2tau_syst_180621.root";
...
void datacard_maker_n_jet_CSVmedium_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_n_jet_CSVmedium_1l2tau_syst_180621.root";
...
void datacard_maker_ETmiss_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_ETmiss_1l2tau_syst_180621.root";
...
void datacard_maker_pT_lep_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_lep_1l2tau_syst_180621.root";
...
void datacard_maker_pT_mu_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_mu_1l2tau_syst_180621.root";
...
void datacard_maker_pT_ele_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_ele_1l2tau_syst_180621.root";
...
void datacard_maker_pT_tau1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_tau1_1l2tau_syst_180621.root";
...
void datacard_maker_pT_tau2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_tau2_1l2tau_syst_180621.root";
...
void datacard_maker_DM_tau1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_DM_tau1_1l2tau_syst_180621.root";
...
void datacard_maker_DM_tau2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_DM_tau2_1l2tau_syst_180621.root";
...
void datacard_maker_pT_jet1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_jet1_1l2tau_syst_180621.root";
...
void datacard_maker_pT_jet2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_jet2_1l2tau_syst_180621.root";
...
void datacard_maker_pT_bjet1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_bjet1_1l2tau_syst_180621.root";
...
void datacard_maker_pT_bjet2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_pT_bjet2_1l2tau_syst_180621.root";
...
void datacard_maker_CSV_jet1_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_DeepCSV_jet1_1l2tau_syst_180621.root";
...
void datacard_maker_CSV_jet2_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_DeepCSV_jet2_1l2tau_syst_180621.root";
...
void datacard_maker_mltau_1l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_mltau_1l2tau_syst_180621.root";
...
void datacard_maker_nvtx_1l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/1l2tau/datacard_nvtx_1l2tau_syst_180621.root";
