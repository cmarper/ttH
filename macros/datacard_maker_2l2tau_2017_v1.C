...
void datacard_maker(TString var1, int nbin, float xmin, float xmax, double* x,
  ...
  cat_names.push_back("ttH_2l_2tau");
  ...
  for(unsigned int i_cat=0;i_cat<cat_names.size();i_cat++){
    ...
    for(unsigned i_MC=0;i_MC<MC_sample_name.size();i_MC++){
      ...
      TH1F* h_MC_genmatch = single_plot(filename_MC[i_MC],
					"HTauTauTree_2l_2tau_fake_CR",
					var,
					MC_weight + Form("*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*tauSF_weight*event_weight_ttH*(category==%i && isGenMatched &&",cat_fakes[i_cat]) + MC_sample_cut[i_MC] + " && " + cut_cat + ")",
					nbin,x);
    ...
    for(unsigned int i=0;i<bkg_type.size();i++){
     ...
     h_ttbar->Add( (TH1F*)f_new->Get("x_ttbar_SL"+bkg_type[i]) );
    ...
    h_fakes->Scale(luminosity/41298.); //Data files for 35.867 fb-1
    ...
    TH1F* h_fakes_unweighed =single_plot(filename_data,
					 "HTauTauTree_2l_2tau_fake_CR",
					 var,
					 Form("(category==%i &&",cat_fakes[i_cat]) + cut_cat + ")",
					 nbin,x);
    ...
    h_data_obs->Scale(luminosity/41298.); //Data files for 35.867 fb-1
    ...
    for(unsigned int i_t=0;i_t<jetToTau_FR_syst_names.size();i_t++){       
      ...
      TString cut = weight + Form("*(category==%i &&",cat_fakes[i_cat]) + cut_cat +")";
      ...
      h_FRjt_syst->Scale(luminosity/41298.); //Data files for 35.867 fb-1   
	...
	TString MC_weight = "MC_weight";
        ...
        TString MC_cut = MC_weight + "*PU_weight_ICHEP18*triggerSF_weight*leptonSF_ttH_weight*bTagSF_CSVshape_weight*tauSF_weight*"+weight+Form("*(category==%i && isGenMatched &&",cat_fakes[i_cat]) + MC_sample_cut[i_MC] + " && " + cut_cat + ")";
...
void datacard_maker_mvis_2l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_mvis_2l2tau_syst_28Jun18.root";
...
void datacard_maker_n_fakelep_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_n_fakelep_2l2tau_syst_28Jun18.root";
...
void datacard_maker_n_fakeele_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_n_fakeele_2l2tau_syst_28Jun18.root";
...
void datacard_maker_n_fakemu_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_n_fakemu_2l2tau_syst_28Jun18.root";
...
void datacard_maker_n_faketau_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_n_faketau_2l2tau_syst_28Jun18.root";
...
void datacard_maker_n_jet_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_n_jet_2l2tau_syst_28Jun18.root";
...
void datacard_maker_n_jet_CSVloose_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_n_jet_CSVloose_2l2tau_syst_28Jun18.root";
...
void datacard_maker_n_jet_CSVmedium_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_n_jet_CSVmedium_2l2tau_syst_28Jun18.root";
...
void datacard_maker_ETmiss_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_ETmiss_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_lep_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_lep_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_mu_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_mu_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_ele_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_ele_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_tau1_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_tau1_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_tau2_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_tau2_2l2tau_syst_28Jun18.root";
...
void datacard_maker_DM_tau1_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_DM_tau1_2l2tau_syst_28Jun18.root";
...
void datacard_maker_DM_tau2_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_DM_tau2_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_jet1_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_jet1_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_jet2_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_jet2_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_bjet1_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_bjet1_2l2tau_syst_28Jun18.root";
...
void datacard_maker_pT_bjet2_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_pT_bjet2_2l2tau_syst_28Jun18.root";
...
void datacard_maker_CSV_jet1_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_DeepCSV_jet1_2l2tau_syst_28Jun18.root";
...
void datacard_maker_CSV_jet2_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_DeepCSV_jet2_2l2tau_syst_28Jun18.root";
...
void datacard_maker_mltau_2l2tau(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_mltau_2l2tau_syst_28Jun18.root";
...
void datacard_maker_nvtx_2l2tau_syst(){
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_nvtx_2l2tau_syst_28Jun18.root";
...
void datacard_maker_all(){
  ...
  //datacard_maker_BDT_2l2tau_syst();
  
  datacard_maker_n_fakelep_2l2tau();
  datacard_maker_n_fakeele_2l2tau();
  datacard_maker_n_fakemu_2l2tau();
  datacard_maker_n_faketau_2l2tau();
  datacard_maker_n_jet_2l2tau();
  datacard_maker_n_jet_CSVloose_2l2tau();
  datacard_maker_n_jet_CSVmedium_2l2tau();
  datacard_maker_ETmiss_2l2tau();
  datacard_maker_pT_lep_2l2tau();
  datacard_maker_pT_tau1_2l2tau();
  datacard_maker_pT_tau2_2l2tau();
  datacard_maker_pT_jet1_2l2tau();
  datacard_maker_pT_jet2_2l2tau();
  datacard_maker_CSV_jet1_2l2tau();
  datacard_maker_CSV_jet2_2l2tau();
  datacard_maker_pT_bjet1_2l2tau();
  datacard_maker_pT_bjet2_2l2tau();
...
/*void datacard_maker_BDT_2l2tau_syst(){

  TString var="MVA_2l2tau_ttbar";
  ...
  TString file="/data_CMS/cms/mperez/ttH_2017/datacards/2l2tau/datacard_BDT_2l2tau_syst_28Jun18.root";
