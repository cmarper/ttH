...
void write_mu_log(){
  ...
  //std::ofstream out("mu_180120_ttH.txt");
  std::ofstream out("../sync_94X/log_LLR_mu_v4.txt");
 
  //TString file="/data_CMS/cms/strebler/ttH_prod_80X_11_2016/syncNtuples/syncNtuple_ttW_multilep.root";
  //TString file="/data_CMS/cms/mperez/ttH_2017/syncNtuples/syncNtuple_ttH.root";
  TString file="/data_CMS/cms/mperez/ttH_2017/syncNtuples/syncNtuple_ttH_v4.root"; 
...
void write_ele_log(){
  ...
  std::ofstream out("../sync_94X/log_LLR_ele_v4.txt");
...
//  std::ofstream out("tau_180130_ttW.txt");
  std::ofstream out("../sync_94X/log_LLR_tau_v4.txt");
...
void write_jet_log(){
  ...
  //std::ofstream out("jet_180130_ttH.txt");
  std::ofstream out("../sync_94X/log_LLR_jet_v4.txt");
